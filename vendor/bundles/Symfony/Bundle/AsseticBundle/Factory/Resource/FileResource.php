...
class FileResource implements ResourceInterface {
	 ...
	 */
	public function __construct(LoaderInterface $loader, $bundle, $baseDir,
			$path) {
		$this->loader = $loader;
		$this->bundle = $bundle;
	...
	protected function getTemplate() {
		if (null === $this->template) {
			$this->template = self::createTemplateReference($this->bundle,
					substr($this->path, strlen($this->baseDir)));
		}
	...
	static private function createTemplateReference($bundle, $file) {
		...
		return new TemplateReference($bundle, implode('/', $parts),
