...
abstract class AsseticHelper extends Helper {
	 ...
	 */
	public function javascripts($inputs = array(), $filters = array(),
			array $options = array()) {
	 ...
	 */
	public function stylesheets($inputs = array(), $filters = array(),
			array $options = array()) {
		if (!isset($options['output'])) {
	 ...
	 */
	public function image($inputs = array(), $filters = array(),
			array $options = array()) {
		if (!isset($options['output'])) {
	 ...
	 */
	private function getAssetUrls($inputs = array(), $filters = array(),
			array $options = array()) {
	 ...
	 */
	abstract protected function getAssetUrl(AssetInterface $asset,
			$options = array());
