...
class ShellTestCase extends SimpleTestCase {
	...
	function assertExitCode($status, $message = "%s") {
		$message = sprintf($message,
				"Expected status code of [$status] from ["
	...
	function assertOutput($expected, $message = "%s") {
		$shell = $this->getShell();
		return $this
				->assert(new EqualExpectation($expected), $shell->getOutput(),
						$message);
	}
	...
	function assertOutputPattern($pattern, $message = "%s") {
		$shell = $this->getShell();
		return $this
				->assert(new PatternExpectation($pattern), $shell->getOutput(),
						$message);
	}
