...
class HtmlReporter extends SimpleReporter {
	...
	function paintFooter($test_name) {
		$colour = ($this->getFailCount() + $this->getExceptionCount() > 0 ? "red"
				: "green");
		print "<div style=\"";
		print 
	...
	function paintError($message) {
		...
		print implode(" -&gt; ", $breadcrumb);
		print 
				" -&gt; <strong>" . $this->htmlEntities($message)
						. "</strong><br />\n";
	}
	...
	function paintFooter($test_name) {
		...
		print 
				"Test cases run: " . $this->getTestCaseProgress() . "/"
						. $this->getTestCaseCount() . ", Passes: "
						. $this->getPassCount() . ", Failures: "
						. $this->getFailCount() . ", Exceptions: "
...
class SelectiveReporter extends SimpleReporterDecorator {
	 ...
	 */
	function __construct($reporter, $just_this_case = false,
