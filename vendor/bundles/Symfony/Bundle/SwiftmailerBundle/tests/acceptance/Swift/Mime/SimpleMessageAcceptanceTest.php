...
class Swift_Mime_SimpleMessageAcceptanceTest extends
	...
	public function testEncoderCanBeSet() {
		...
		$message
				->setEncoder(
						new Swift_Mime_ContentEncoder_PlainContentEncoder(
								'7bit'));
		$id = $message->getId();
		$date = $message->getDate();
		$this
	...
	public function testFromAddressCanBeSetWithName() {
		...
		$message
				->setFrom(
						array('chris.corbyn@swiftmailer.org' => 'Chris Corbyn'));
		$id = $message->getId();
		$date = $message->getDate();
		$this
				->assertEqual(
	...
	public function testMultipleReplyAddressCanBeUsed() {
		...
		$message
				->setReplyTo(
						array('chris@w3style.co.uk' => 'Myself',
	...
	public function testMultipleCcAddressesCanBeSet() {
		...
		$message
				->setCc(
						array('john@some-site.com' => 'John West',
