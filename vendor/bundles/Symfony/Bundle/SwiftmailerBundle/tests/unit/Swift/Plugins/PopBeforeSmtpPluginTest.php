...
class Swift_Plugins_PopBeforeSmtpPluginTest extends
	...
	public function testPluginConnectsToPop3HostBeforeTransportStarts() {
		...
		$this
				->_checking(
						Expectations::create()->one($connection)->connect()
								->ignoring($connection));
	...
	public function testPluginDisconnectsFromPop3HostBeforeTransportStarts() {
		...
		$this
				->_checking(
						Expectations::create()->one($connection)->disconnect()
								->ignoring($connection));
	...
	public function testPluginDoesNotConnectToSmtpIfBoundToDifferentTransport() {
		...
		$this
				->_checking(Expectations::create()->never($connection));
