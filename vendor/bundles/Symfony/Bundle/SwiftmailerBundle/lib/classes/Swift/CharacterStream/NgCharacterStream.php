...
Class Swift_CharacterStream_NgCharacterStream implements Swift_CharacterStream {
	...
	public function read($length) {
		...
		$ret = false;
		$length = ($this->_currentPos + $length > $this->_charCount) ? $this
						->_charCount - $this->_currentPos : $length;
	...
	public function write($chars) {
		...
		$ignored = '';
		$this->_datas .= $chars;
		$this->_charCount += $this->_charReader
				->getCharPositions(substr($this->_datas, $this->_datasSize),
