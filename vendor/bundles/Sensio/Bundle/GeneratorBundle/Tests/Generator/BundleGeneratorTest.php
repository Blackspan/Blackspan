...
class BundleGeneratorTest extends GeneratorTest {
	public function testGenerateYaml() {
		...
		$generator
				->generate('Foo\BarBundle', 'FooBarBundle', $this->tmpDir,
						'yml', false);

		$files = array('FooBarBundle.php', 'Controller/DefaultController.php',
	...
	public function testGenerateAnnotation() {
		...
		$this
				->assertFalse(
						file_exists(
								$this->tmpDir
										. '/Foo/BarBundle/Resources/config/routing.yml'));
		$this
				->assertFalse(
						file_exists(
								$this->tmpDir
										. '/Foo/BarBundle/Resources/config/routing.xml'));
