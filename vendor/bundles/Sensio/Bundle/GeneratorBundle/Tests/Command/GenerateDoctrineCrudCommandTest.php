...
class GenerateDoctrineCrudCommandTest extends GenerateCommandTest {
	...
	public function testInteractiveCommand($options, $input, $expected) {
		...
		$generator->expects($this->once())->method('generate')
				->with($this->getBundle(), $entity,
						$this->getDoctrineMetadata(), $format, $prefix,
						$withWrite);
	...
	public function getInteractiveCommandData() {
		return array(
				...
				array(array(), "AcmeBlogBundle:Blog/Post\ny\nyml\n/foobar\n",
						array('Blog\\Post', 'yml', 'foobar', true)),
				array(
						array('--entity' => 'AcmeBlogBundle:Blog/Post',
								'--format' => 'yml', '--route-prefix' => 'foo',
								'--with-write' => true), '',
	...
	protected function getCommand($generator, $input) {
		$command = $this
				...
				->setMethods(array('getEntityMetadata'))->getMock();

		$command->expects($this->any())->method('getEntityMetadata')
	...
	protected function getFormGenerator() {
		return $this
				->getMockBuilder(
						'Sensio\Bundle\GeneratorBundle\Generator\DoctrineFormGenerator')
				->disableOriginalConstructor()->setMethods(array('generate'))
				->getMock();
	}
	...
	protected function getContainer() {
		...
		$registry->expects($this->any())->method('getEntityNamespace')
