...
class UserProxy extends FosUser {
	...
	public function __call($method, $arguments) {
		if (is_callable(array($this->getPropelUser(), $method))) {
			return call_user_func_array(
					array($this->getPropelUser(), $method), $arguments);
		}
	...
	public function isAccountNonExpired() {
		...
		if (null !== $this->user->getExpiresAt()
				&& $this->user->getExpiresAt()->getTimestamp() < time()) {
			return false;
		}
	...
	public function isCredentialsNonExpired() {
		...
		if (null !== $this->user->getCredentialsExpireAt()
				&& $this->user->getCredentialsExpireAt()->getTimestamp()
						< time()) {
			return false;
		}
