...
class UserManipulatorTest extends \PHPUnit_Framework_TestCase {
	public function testCreate() {
		...
		$userManagerMock->expects($this->once())->method('createUser')
		...
		$manipulator
				->create($username, $password, $email, $active, $superadmin);
	...
	public function testActivateWithValidUsername() {
		...
		$userManagerMock->expects($this->once())->method('findUserByUsername')
				->will($this->returnValue($user))
