...
class FOSUserExtensionTest extends \PHPUnit_Framework_TestCase {
	...
	public function testUserLoadModelClassWithDefaults() {
		...
		$this
				->assertParameter('Acme\MyBundle\Document\User',
	...
	public function testUserLoadModelClass() {
		...
		$this
				->assertParameter('Acme\MyBundle\Entity\User',
						'fos_user.model.user.class');
	}
	...
	public function testUserLoadManagerClassWithDefaults() {
		...
		$this
				->assertAlias('fos_user.user_manager.default',
	...
	public function testUserLoadManagerClass() {
		...
		$this
				->assertAlias('fos_user.group_manager.default',
	...
	public function testUserLoadFormClassWithDefaults() {
		...
		$this
				->assertParameter('fos_user_profile',
						'fos_user.profile.form.type');
		$this
				->assertParameter('fos_user_registration',
						'fos_user.registration.form.type');
		$this
				->assertParameter('fos_user_change_password',
						'fos_user.change_password.form.type');
		$this
				->assertParameter('fos_user_resetting',
	...
	public function testUserLoadFormClass() {
		...
		$this
				->assertParameter('acme_my_registration',
						'fos_user.registration.form.type');
		$this->assertParameter('acme_my_group', 'fos_user.group.form.type');
		$this
				->assertParameter('acme_my_change_password',
						'fos_user.change_password.form.type');
		$this
				->assertParameter('acme_my_resetting',
						'fos_user.resetting.form.type');
	}
	...
	public function testUserLoadFormNameWithDefaults() {
		...
		$this
				->assertParameter('fos_user_profile_form',
						'fos_user.profile.form.name');
		$this
				->assertParameter('fos_user_registration_form',
						'fos_user.registration.form.name');
		$this
				->assertParameter('fos_user_change_password_form',
						'fos_user.change_password.form.name');
		$this
				->assertParameter('fos_user_resetting_form',
	...
	public function testUserLoadFormName() {
		...
		$this
				->assertParameter('acme_profile_form',
						'fos_user.profile.form.name');
		$this
				->assertParameter('acme_registration_form',
						'fos_user.registration.form.name');
		$this->assertParameter('acme_group_form', 'fos_user.group.form.name');
		$this
				->assertParameter('acme_change_password_form',
						'fos_user.change_password.form.name');
		$this
				->assertParameter('acme_resetting_form',
						'fos_user.resetting.form.name');
	}
	...
	public function testUserLoadConfirmationEmailWithDefaults() {
		...
		$this
				->assertParameter('FOSUserBundle:Registration:email.txt.twig',
						'fos_user.registration.confirmation.template');
		$this
				->assertParameter('FOSUserBundle:Resetting:email.txt.twig',
						'fos_user.resetting.email.template');
		$this
				->assertParameter(
						array('webmaster@example.com' => 'webmaster'),
	...
	public function testUserLoadConfirmationEmail() {
		...
		$this
				->assertParameter(true,
						'fos_user.registration.confirmation.enabled');
		$this
				->assertParameter(array('register@acme.org' => 'Acme Corp'),
						'fos_user.registration.confirmation.from_email');
		$this
				->assertParameter('AcmeMyBundle:Registration:mail.txt.twig',
						'fos_user.registration.confirmation.template');
		$this
				->assertParameter('AcmeMyBundle:Resetting:mail.txt.twig',
						'fos_user.resetting.email.template');
		$this
				->assertParameter(array('reset@acme.org' => 'Acme Corp'),
						'fos_user.resetting.email.from_email');
	...
	public function testUserLoadTemplateConfigWithDefaults() {
		...
		$this
				->assertParameter('FOSUserBundle::form.html.twig',
	...
	public function testUserLoadTemplateConfig() {
		...
		$this
				->assertParameter('AcmeMyBundle:Form:theme.html.twig',
						'fos_user.template.theme');
	}
	...
	public function testUserLoadUtilServiceWithDefaults() {
		...
		$this
				->assertAlias('fos_user.util.canonicalizer.default',
	...
	public function testUserLoadUtilService() {
		...
		$this
				->assertAlias('acme_my.email_canonicalizer',
						'fos_user.util.email_canonicalizer');
		$this
				->assertAlias('acme_my.username_canonicalizer',
						'fos_user.util.username_canonicalizer');
	}
...
EOF;
	...
	private function assertAlias($value, $key) {
		$this
				->assertEquals($value,
						(string) $this->configuration->getAlias($key),
	...
	private function assertHasDefinition($id) {
		$this
				->assertTrue(
						($this->configuration->hasDefinition($id) ? 
