...
class ControllerListenerTest extends \PHPUnit_Framework_TestCase {
	...
	public function getIgnoredControllers() {
		return array(array('array_merge'), array(function () {
		}),);
	}
	...
	public function testOnCoreController() {
		...
		list($methodInvocation, $metadata) = call_user_func_array(
				$newController, $passedArgs);
		...
		$expected = array('roles' => array('ROLE_FOO'),
				'run_as_roles' => array(), 'param_permissions' => array(),
