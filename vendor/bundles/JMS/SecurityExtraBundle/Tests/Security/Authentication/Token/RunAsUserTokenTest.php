...
class RunAsUserTokenTest extends \PHPUnit_Framework_TestCase {
	public function testConstructor() {
		...
		$runAsToken = new RunAsUserToken('foo', $user, 'secret',
	...
	public function testEraseCredentials() {
		$token = new RunAsUserToken('foo', 'foo', 'secret', array(),
				$this
						->getMock(
								'Symfony\Component\Security\Core\Authentication\Token\TokenInterface'));
	...
	public function testSerializeUnserialize() {
		$token = new RunAsUserToken('foo', 'bar', 'secret', array(),
				new UsernamePasswordToken('foo', 'pass', 'foo', array()));
