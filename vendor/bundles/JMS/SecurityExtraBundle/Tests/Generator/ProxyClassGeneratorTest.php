...
class ProxyClassGeneratorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGenerate($class, $method, array $arguments) {
		...
		$proxyClass
				->jmsSecurityExtraBundle__setMethodSecurityInterceptor($mock);

		$this
				->assertSame($return,
						call_user_func_array(array($proxyClass, $method),
								$arguments));
	}

	public function getTestData() {
		return array(
				array('JMS\SecurityExtraBundle\Tests\Generator\FooService',
						'foo', array('foo')),
				array(
						'JMS\SecurityExtraBundle\Tests\Generator\AnotherService',
						'foo', array()),);
	}
}
