...
class AsseticNode extends \Twig_Node {
	...
	public function __construct(AssetInterface $asset,
		...
		$attributes = array_replace(
				array('debug' => null, 'combine' => null,
						'var_name' => 'asset_url'), $attributes,
				array('asset' => $asset, 'inputs' => $inputs,
	...
	public function compile(\Twig_Compiler $compiler) {
		...
		if (null === $combine) {
			...
			$this
					->compileAsset($compiler, $this->getAttribute('asset'),
		...
		$compiler->write('unset($context[')
				->repr($this->getAttribute('var_name'))->raw("]);\n");
	}
	...
	protected function compileAsset(\Twig_Compiler $compiler,
