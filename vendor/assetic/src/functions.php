 ...
 */
function assetic_javascripts($inputs = array(), $filters = array(),
		array $options = array()) {
 ...
 */
function assetic_stylesheets($inputs = array(), $filters = array(),
		array $options = array()) {
	if (!isset($options['output'])) {
 ...
 */
function _assetic_urls($inputs = array(), $filters = array(),
		array $options = array()) {
	global $_assetic;
