...
class AssetWriterTest extends \PHPUnit_Framework_TestCase {
	protected function setUp() {
		$this->dir = sys_get_temp_dir() . '/assetic_tests_'
				. rand(11111, 99999);
		mkdir($this->dir);
	...
	public function testWriteManagerAssets() {
		...
		$am->expects($this->once())->method('getNames')
				->will($this->returnValue(array('foo')));
		$am->expects($this->once())->method('get')->with('foo')
		...
		$this
				->assertEquals('content',
						file_get_contents($this->dir . '/target_url'));
	}
}
