...
class FilterCollectionTest extends \PHPUnit_Framework_TestCase {
	public function testInterface() {
		...
		$this
				->assertInstanceOf('Assetic\\Filter\\FilterInterface', $filter,
						'FilterCollection implements FilterInterface');
	}
	...
	public function testAll() {
		$filter = new FilterCollection(
				array($this->getMock('Assetic\\Filter\\FilterInterface'),
						$this->getMock('Assetic\\Filter\\FilterInterface'),));

		$this
				->assertInternalType('array', $filter->all(),
