...
class StylusFilterTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->filter = new StylusFilter($_SERVER['NODE_BIN'],
				array($_SERVER['NODE_PATH']));
	}
	...
	public function testFilterLoadWithCompression() {
		...
		$this
				->assertEquals(
						"body{font:12px Helvetica,Arial,sans-serif;color:#000}\n",
						$asset->getContent(),
						'->filterLoad() parses the content and compress it');
	}
}
