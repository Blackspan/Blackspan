...
class TwigFormulaLoaderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testMixture() {
		...
		$expected = array(
				'mixture' => array(array('foo', 'foo/*', '@foo'), array(),
						array('output' => 'packed/mixture',
								'name' => 'mixture', 'debug' => false,
								'combine' => null,),),);
	...
	public function testFunction() {
		$expected = array(
				'my_asset' => array(array('path/to/asset'),
						array('some_filter'),
