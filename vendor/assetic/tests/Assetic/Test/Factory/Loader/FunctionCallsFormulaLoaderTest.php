...
class FunctionCallsFormulaLoaderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testInput($function, $inputs, $name, $expected) {
		...
		$resource->expects($this->once())->method('getContent')
				->will(
						$this
								->returnValue(
										'<?php ' . $function . '(' . $inputs
												. ') ?>'));
		$factory->expects($this->once())->method('generateAssetName')
	...
	public function getJavascriptInputs() {
		return array(
				array('assetic_javascripts', '"js/core.js"', 'asdf',
						array(
								'asdf' => array(array('js/core.js'), array(),
										array('debug' => false,
												'output' => 'js/*.js',
												'name' => 'asdf',)))),
				array('assetic_javascripts', "'js/core.js'", 'asdf',
						array(
								'asdf' => array(array('js/core.js'), array(),
										array('debug' => false,
												'output' => 'js/*.js',
												'name' => 'asdf',)))),
				array('assetic_javascripts', "array('js/core.js')", 'asdf',
						array(
								'asdf' => array(array('js/core.js'), array(),
										array('debug' => false,
												'output' => 'js/*.js',
						...
						array(
								'asdf' => array(array('js/core.js'), array(),
										array('debug' => false,
												'output' => 'js/*.js',
												'name' => 'asdf',)))),
				array('assetic_image', '"images/logo.gif"', 'asdf',
						array(
								'asdf' => array(array('images/logo.gif'),
										array(),
										array('debug' => false,
												'output' => 'images/*',
												'name' => 'asdf')))),);
