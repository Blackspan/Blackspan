...
class DirectoryResourceTest extends \PHPUnit_Framework_TestCase {
	...
	public function getPatterns() {
		return array(array(null), array('/\.php$/'), array('/\.foo$/'),);
	}
	...
	public function getPatternsAndEmpty() {
		return array(array(null, false), array('/\.php$/', false),
				array('/\.foo$/', true),);
	}

	public function testRecursiveIteration() {
		$resource = new DirectoryResource(realpath(__DIR__ . '/..'),
	...
	public function testTrailingSlash($path) {
		...
		$this
				->assertStringEndsWith(DIRECTORY_SEPARATOR, (string) $resource,
						'path ends with a slash');
	}

	public function getPaths() {
		return array(array(__DIR__), array(__DIR__ . DIRECTORY_SEPARATOR),);
	}

	public function testInvalidDirectory() {
		$resource = new DirectoryResource(__DIR__ . 'foo');
		$this
				->assertEquals(0, iterator_count($resource),
						'works for non-existent directory');
	}
}
