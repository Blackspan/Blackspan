...
class CoalescingDirectoryResourceTest extends \PHPUnit_Framework_TestCase {
	...
	public function shouldFilterFiles() {
		...
		$resource = new CoalescingDirectoryResource(
				array(
						new DirectoryResource(__DIR__ . '/Fixtures/dir1/',
								'/\.txt$/'),
						new DirectoryResource(__DIR__ . '/Fixtures/dir2',
								'/\.txt$/'),));
		...
		$this
				->assertEquals(
						array(__DIR__ . '/Fixtures/dir1/file1.txt',
								__DIR__ . '/Fixtures/dir1/file2.txt',
								__DIR__ . '/Fixtures/dir2/file3.txt',), $paths,
						'files from multiple directories are merged');
	}
}
