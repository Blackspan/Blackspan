...
class GlobAssetTest extends \PHPUnit_Framework_TestCase {
	...
	public function testIteration() {
		...
		$this
				->assertGreaterThan(0, iterator_count($assets),
						'GlobAsset initializes for iteration');
	}
	...
	public function testRecursiveIteration() {
		...
		$this
				->assertGreaterThan(0, iterator_count($assets),
						'GlobAsset initializes for recursive iteration');
	}

	public function testGetLastModifiedType() {
		$assets = new GlobAsset(__DIR__ . '/*.php');
		$this
				->assertInternalType('integer', $assets->getLastModified(),
	...
	public function testGetLastModifiedValue() {
		$assets = new GlobAsset(__DIR__ . '/*.php');
		$this
				->assertLessThan(time(), $assets->getLastModified(),
						'->getLastModified() returns a file mtime');
	}
