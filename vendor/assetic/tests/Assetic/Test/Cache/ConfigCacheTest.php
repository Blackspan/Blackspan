...
class ConfigCacheTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCache() {
		...
		$this
				->assertEquals(array(1, 2, 3), $this->cache->get('foo'),
	...
	public function testTimestamp() {
		...
		$this
				->assertInternalType('integer',
						$time = $this->cache->getTimestamp('bar'),
						'->getTimestamp() returns an integer');
		$this
				->assertNotEmpty($time,
						'->getTimestamp() returns a non-empty number');
	}
