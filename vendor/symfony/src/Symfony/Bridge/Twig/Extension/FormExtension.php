...
class FormExtension extends \Twig_Extension {
	...
	public function getFunctions() {
		return array(
				'form_enctype' => new \Twig_Function_Method($this,
						'renderEnctype', array('is_safe' => array('html'))),
				'form_widget' => new \Twig_Function_Method($this,
						'renderWidget', array('is_safe' => array('html'))),
				'form_errors' => new \Twig_Function_Method($this,
						'renderErrors', array('is_safe' => array('html'))),
				'form_label' => new \Twig_Function_Method($this, 'renderLabel',
						array('is_safe' => array('html'))),
				'form_row' => new \Twig_Function_Method($this, 'renderRow',
						array('is_safe' => array('html'))),
				'form_rest' => new \Twig_Function_Method($this, 'renderRest',
						array('is_safe' => array('html'))),
				'_form_is_choice_group' => new \Twig_Function_Method($this,
						'isChoiceGroup', array('is_safe' => array('html'))),
				'_form_is_choice_selected' => new \Twig_Function_Method($this,
						'isChoiceSelected', array('is_safe' => array('html'))),);
	}
	 ...
	 */
	protected function render(FormView $view, $section,
			array $variables = array()) {
		...
		if (isset($this->varStack[$rendering])) {
			...
			$this->varStack[$rendering] = array(
					'variables' => array_replace_recursive($view->all(),
	...
	protected function getBlocks(FormView $view) {
		if (!$this->blocks->contains($view)) {
			...
			foreach ($templates as $template) {
				...
				do {
					$templateBlocks = array_merge($template->getBlocks(),
							$templateBlocks);
			...
			if (!$rootView) {
				$blocks = array_merge($this->getBlocks($view->getParent()),
						$blocks);
			}
