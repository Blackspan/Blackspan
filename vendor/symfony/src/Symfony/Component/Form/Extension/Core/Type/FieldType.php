...
class FieldType extends AbstractType {
	...
	public function buildForm(FormBuilder $builder, array $options) {
		...
		if (false === $options['property_path']
			...
			$options['property_path'] = new PropertyPath(
					$options['property_path']);
		}
	...
	public function buildView(FormView $view, FormInterface $form) {
		...
		$view->set('form', $view)->set('id', $id)->set('name', $name)
				...
				->set('size', null)->set('label', $form->getAttribute('label'))
				->set('multipart', false)
	...
	public function getDefaultOptions(array $options) {
		$defaultOptions = array('data' => null, 'data_class' => null,
				'trim' => true, 'required' => true,
				'read_only' => false, 'max_length' => null,
				'pattern' => null, 'property_path' => null,
				'by_reference' => true, 'error_bubbling' => false,
				'error_mapping' => array(), 'label' => null,
				'attr' => array(),
	 ...
	 * {@inheritdoc}
	 */
	public function createBuilder($name, FormFactoryInterface $factory,
			array $options) {
