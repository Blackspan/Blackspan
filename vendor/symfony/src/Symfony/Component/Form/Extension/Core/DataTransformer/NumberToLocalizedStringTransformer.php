...
class NumberToLocalizedStringTransformer implements DataTransformerInterface {
	...
	public function __construct($precision = null, $grouping = null,
			$roundingMode = null) {
		if (null === $grouping) {
			$grouping = false;
		}
	...
	protected function getNumberFormatter() {
		$formatter = new \NumberFormatter(\Locale::getDefault(),
		...
		$formatter
				->setAttribute(\NumberFormatter::GROUPING_USED, $this->grouping);
