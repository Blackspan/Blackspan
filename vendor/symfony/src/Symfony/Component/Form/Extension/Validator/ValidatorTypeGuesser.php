...
class ValidatorTypeGuesser implements FormTypeGuesserInterface {
	...
	public function guessType($class, $property) {
		...
		return $this
				->guess($class, $property,
						function (Constraint $constraint) use ($guesser) {
							return $guesser
									->guessTypeForConstraint($constraint);
						});
	}
	...
	public function guessRequired($class, $property) {
		...
		return $this
				->guess($class, $property,
						function (Constraint $constraint) use ($guesser) {
							return $guesser
									->guessRequiredForConstraint($constraint);
						});
	}
	...
	public function guessMaxLength($class, $property) {
		...
		return $this
				->guess($class, $property,
						function (Constraint $constraint) use ($guesser) {
							return $guesser
									->guessMaxLengthForConstraint($constraint);
						});
	}
	...
	public function guessMinLength($class, $property) {
		...
		return $this
				->guess($class, $property,
						function (Constraint $constraint) use ($guesser) {
							return $guesser
									->guessMinLengthForConstraint($constraint);
						});
	}
	...
	public function guessTypeForConstraint(Constraint $constraint) {
		...
		case 'Symfony\Component\Validator\Constraints\Type':
			...
			case 'boolean':
			case 'bool':
				return new TypeGuess('checkbox', array(),
						Guess::MEDIUM_CONFIDENCE);
			case 'double':
			case 'float':
			case 'numeric':
			case 'real':
				return new TypeGuess('number', array(),
						Guess::MEDIUM_CONFIDENCE);
			case 'integer':
			case 'int':
			case 'long':
				return new TypeGuess('integer', array(),
						Guess::MEDIUM_CONFIDENCE);
			case 'string':
		...
		case 'Symfony\Component\Validator\Constraints\Date':
			return new TypeGuess('date', array('type' => 'string'),
					Guess::HIGH_CONFIDENCE);
		case 'Symfony\Component\Validator\Constraints\DateTime':
			return new TypeGuess('datetime', array('type' => 'string'),
					Guess::HIGH_CONFIDENCE);
		...
		case 'Symfony\Component\Validator\Constraints\Time':
			return new TypeGuess('time', array('type' => 'string'),
					Guess::HIGH_CONFIDENCE);
	...
	public function guessMaxLengthForConstraint(Constraint $constraint) {
		...
		case 'Symfony\Component\Validator\Constraints\Max':
			return new ValueGuess(strlen((string) $constraint->limit),
					Guess::HIGH_CONFIDENCE);
		}
	}
