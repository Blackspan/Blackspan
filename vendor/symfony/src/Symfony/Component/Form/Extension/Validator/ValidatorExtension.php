...
class ValidatorExtension extends AbstractExtension {
	...
	public function __construct(ValidatorInterface $validator) {
		...
		$metadata = $this->validator->getMetadataFactory()
				->getClassMetadata('Symfony\Component\Form\Form');
		$metadata
				->addConstraint(
						new Callback(
								array(
	...
	protected function loadTypeExtensions() {
		return array(new Type\FieldTypeValidatorExtension($this->validator),);
	}
}
