...
interface MutableAclInterface extends AclInterface {
	 ...
	 * @return void
	 */
	function insertClassAce(SecurityIdentityInterface $sid, $mask, $index = 0,
			$granting = true, $strategy = null);
	 ...
	 * @return void
	 */
	function insertClassFieldAce($field, SecurityIdentityInterface $sid, $mask,
	 ...
	 * @return void
	 */
	function insertObjectAce(SecurityIdentityInterface $sid, $mask, $index = 0,
			$granting = true, $strategy = null);
	 ...
	 * @return void
	 */
	function insertObjectFieldAce($field, SecurityIdentityInterface $sid, $mask,
			$index = 0, $granting = true, $strategy = null);
