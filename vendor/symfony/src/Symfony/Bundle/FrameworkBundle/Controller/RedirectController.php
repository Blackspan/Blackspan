...
class RedirectController extends ContainerAware {
	...
	public function redirectAction($route, $permanent = false) {
		...
		return new RedirectResponse(
				$this->container->get('router')->generate($route, $attributes),
				$permanent ? 301 : 302);
	}
	 ...
	 * @return Response A Response instance
	 */
	public function urlRedirectAction($path, $permanent = false, $scheme = null,
		...
		$url = $scheme . '://' . $request->getHost() . $port
				. $request->getBaseUrl() . $path . $qs;
