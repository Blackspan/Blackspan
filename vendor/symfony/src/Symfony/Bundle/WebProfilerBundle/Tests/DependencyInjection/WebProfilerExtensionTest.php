...
class WebProfilerExtensionTest extends TestCase {
	...
	protected function setUp() {
		...
		$this->container
				->register('templating.engine.twig',
						$this
								->getMockClass(
										'Symfony\\Bundle\\TwigBundle\\TwigEngine'))
				->addArgument(
						new Definition($this->getMockClass('Twig_Environment')))
				->addArgument(
						new Definition(
								$this
										->getMockClass(
	...
	public function testDefaultConfig($debug) {
		...
		$this
				->assertFalse(
						$this->container->get('web_profiler.debug_toolbar')
								->isEnabled());
	...
	public function getDebugModes() {
		return array(array(true, true), array(true, false),
				array(false, false), array(false, true),);
	}
