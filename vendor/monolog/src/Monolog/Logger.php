...
class Logger {
	...
	protected static $levels = array(100 => 'DEBUG', 200 => 'INFO',
	...
	public function addRecord($level, $message, array $context = array()) {
		...
		$record = array('message' => (string) $message, 'context' => $context,
				'level' => $level, 'level_name' => self::getLevelName($level),
				'channel' => $this->name, 'datetime' => new \DateTime(),
				'extra' => array(),);
