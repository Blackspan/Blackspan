...
class EntityChoiceListTest extends DoctrineOrmTestCase {
	...
	public function testEntitesMustHaveAToStringMethod() {
		...
		$choiceList = new EntityChoiceList($this->em, self::SINGLE_IDENT_CLASS,
				null, null,
	...
	public function testNestedChoicesAreManaged() {
		...
		$choiceList = new EntityChoiceList($this->em, self::SINGLE_IDENT_CLASS,
				'name', null,
				array('group1' => array($entity1), 'group2' => array($entity2),));

		$this
				->assertSame(
						array('group1' => array(1 => 'Foo'),
								'group2' => array(2 => 'Bar')),
						$choiceList->getChoices());
	}
}
