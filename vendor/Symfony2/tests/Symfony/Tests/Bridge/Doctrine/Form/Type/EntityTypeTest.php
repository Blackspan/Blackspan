...
class EntityTypeTest extends TypeTestCase {
	...
	public function testSetDataToUninitializedEntityWithNonRequired() {
		...
		$field = $this->factory
				->createNamed('entity', 'name', null,
						array('em' => 'default',
								'class' => self::SINGLE_IDENT_CLASS,
								'required' => false, 'property' => 'name'));

		$this
				->assertEquals(array(1 => 'Foo', 2 => 'Bar'),
	...
	public function testSetDataSingleNull() {
		$field = $this->factory
				->createNamed('entity', 'name', null,
						array('multiple' => false, 'em' => 'default',
								'class' => self::SINGLE_IDENT_CLASS,));
		$field->setData(null);
	...
	public function testSubmitMultipleNull() {
		$field = $this->factory
				->createNamed('entity', 'name', null,
						array('multiple' => true, 'em' => 'default',
								'class' => self::SINGLE_IDENT_CLASS,));
		$field->bind(null);
	...
	protected function createRegistryMock($name, $em) {
		...
		$registry->expects($this->any())->method('getEntityManager')
				->with($this->equalTo($name))->will($this->returnValue($em));
