...
class WebProcessorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testUsesRequestServerData() {
		$server = array('REQUEST_URI' => 'A', 'REMOTE_ADDR' => 'B',
				'REQUEST_METHOD' => 'C',);
		...
		$event->expects($this->any())->method('getRequestType')
	...
	protected function getRecord($level = Logger::WARNING, $message = 'test') {
		return array('message' => $message, 'context' => array(),
				'level' => $level,
				'level_name' => Logger::getLevelName($level),
				'channel' => 'test', 'datetime' => new \DateTime(),
				'extra' => array(),);
	}
}
