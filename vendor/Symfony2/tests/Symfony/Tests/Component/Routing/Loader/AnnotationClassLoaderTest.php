...
class AnnotationClassLoaderTest extends AbstractAnnotationLoaderTest {
	...
	public function testLoadAbstractClass() {
		$this->loader
				->load(
						'Symfony\Tests\Component\Routing\Fixtures\AnnotatedClasses\AbstractClass');
	}
	...
	public function testSupportsChecksTypeIfSpecified() {
		$this
				->assertTrue($this->loader->supports('class', 'annotation'),
						'->supports() checks the resource type if specified');
		$this
				->assertFalse($this->loader->supports('class', 'foo'),
						'->supports() checks the resource type if specified');
	}
