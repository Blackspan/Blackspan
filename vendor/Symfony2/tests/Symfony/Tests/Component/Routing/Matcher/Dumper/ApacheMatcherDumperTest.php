...
class ApacheMatcherDumperTest extends \PHPUnit_Framework_TestCase {
	...
	public function testDump() {
		...
		$this
				->assertStringEqualsFile(
						self::$fixturesPath . '/dumper/url_matcher1.apache',
						$dumper->dump(),
	...
	public function testEscapePattern($src, $dest, $char, $with, $message) {
		$r = new \ReflectionMethod(
				new ApacheMatcherDumper($this->getRouteCollection()), 'escape');
		$r->setAccessible(true);
		$this
				->assertEquals($dest, $r->invoke(null, $src, $char, $with),
						$message);
	}
	...
	public function testEscapeScriptName() {
		...
		$this
				->assertStringEqualsFile(
						self::$fixturesPath . '/dumper/url_matcher2.apache',
	...
	private function getRouteCollection() {
		...
		$collection
				->add('baz6',
						new Route('/test/baz', array('foo' => 'bar baz')));
		// space in path
