...
class PhpGeneratorDumperTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->generatorDumper = new PhpGeneratorDumper(
				$this->routeCollection, new RequestContext());
		$this->testTmpFilepath = sys_get_temp_dir() . DIRECTORY_SEPARATOR
				. 'php_generator.php';
	...
	public function testDumpWithRoutes() {
		...
		$this
				->assertEquals($absoluteUrlWithParameter,
						'http://localhost/app.php/testing/bar');
		$this
				->assertEquals($absoluteUrlWithoutParameter,
	...
	public function testDumpWithoutRoutes() {
		file_put_contents($this->testTmpFilepath,
				$this->generatorDumper
						->dump(array('class' => 'WithoutRoutesUrlGenerator')));
		include($this->testTmpFilepath);
	...
	public function testDumpForRouteWithDefaults() {
		$this->routeCollection
				->add('Test',
						new Route('/testing/{foo}', array('foo' => 'bar')));

		file_put_contents($this->testTmpFilepath,
				$this->generatorDumper
						->dump(array('class' => 'DefaultRoutesUrlGenerator')));
		include($this->testTmpFilepath);
