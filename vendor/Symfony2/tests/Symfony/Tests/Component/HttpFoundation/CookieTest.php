...
class CookieTest extends \PHPUnit_Framework_TestCase {
	public function invalidNames() {
		return array(array(''), array(",MyName"), array(";MyName"),
				array(" MyName"), array("\tMyName"), array("\rMyName"),
				array("\nMyName"), array("\013MyName"), array("\014MyName"),);
	}
	...
	public function testGetValue() {
		...
		$this
				->assertSame($value, $cookie->getValue(),
	...
	public function testGetExpiresTime() {
		...
		$this
				->assertEquals(3600, $cookie->getExpiresTime(),
	...
	public function testGetDomain() {
		...
		$this
				->assertEquals('.myfoodomain.com', $cookie->getDomain(),
	...
	public function testToString() {
		...
		$this
				->assertEquals(
						'foo=bar; expires=Fri, 20-May-2011 15:25:52 GMT; domain=.myfoodomain.com; secure; httponly',
						$cookie->__toString(),
