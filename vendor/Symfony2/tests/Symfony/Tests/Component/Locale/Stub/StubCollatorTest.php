...
class StubCollatorTest extends LocaleTestCase {
	...
	public function asortProvider() {
		return array(
				...
				array(array('a', 'b', 'c'), StubCollator::SORT_REGULAR,
						array('a', 'b', 'c'),),
				array(array('c', 'b', 'a'), StubCollator::SORT_REGULAR,
						array(2 => 'a', 1 => 'b', 0 => 'c'),),
				array(array('b', 'c', 'a'), StubCollator::SORT_REGULAR,
						array(2 => 'a', 0 => 'b', 1 => 'c'),),);
	}
	...
	public function testSetAttribute() {
		$collator = $this->createStubCollator();
		$collator
				->setAttribute(StubCollator::NUMERIC_COLLATION,
						StubCollator::ON);
	}
