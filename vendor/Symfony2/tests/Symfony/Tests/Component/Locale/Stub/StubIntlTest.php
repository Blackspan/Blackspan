...
class StubIntlTest extends LocaleTestCase {
	public function codeProvider() {
		return array(array(-129, '[BOGUS UErrorCode]'),
				array(0, 'U_ZERO_ERROR'), array(1, 'U_ILLEGAL_ARGUMENT_ERROR'),
				array(9, 'U_PARSE_ERROR'), array(129, '[BOGUS UErrorCode]'),);
	}
	...
	public function testGetErrorNameWithIntl($code, $name) {
		...
		$this
				->assertSame(intl_error_name($code),
						StubIntl::getErrorName($code));
	}
}
