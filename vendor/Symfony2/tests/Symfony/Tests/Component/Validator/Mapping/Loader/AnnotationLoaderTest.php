...
class AnnotationLoaderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testLoadClassMetadata() {
		...
		$expected
				->addPropertyConstraint('firstName',
						new All(array(new NotNull(), new Min(3))));
		$expected
				->addPropertyConstraint('firstName',
						new All(
								array(
		...
		$expected
				->addPropertyConstraint('firstName',
						new Collection(
								array(
										'fields' => array(
												'foo' => array(new NotNull(),
														new Min(3)),
												'bar' => new Min(5),))));
		$expected
				->addPropertyConstraint('firstName',
						new Choice(
								array('message' => 'Must be one of %choices%',
										'choices' => array('A', 'B'),)));
	...
	public function testLoadParentClassMetadata() {
		...
		$parent_metadata = new ClassMetadata(
				'Symfony\Tests\Component\Validator\Fixtures\EntityParent');
		$loader->loadClassMetadata($parent_metadata);

		$expected_parent = new ClassMetadata(
				'Symfony\Tests\Component\Validator\Fixtures\EntityParent');
