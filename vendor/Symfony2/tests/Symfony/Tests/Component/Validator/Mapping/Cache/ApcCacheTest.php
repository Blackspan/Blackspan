...
class ApcCacheTest extends \PHPUnit_Framework_TestCase {
	...
	public function testWrite() {
		$meta = $this
				...
				->setMethods(array('getClassName'))->getMock();

		$meta->expects($this->once())->method('getClassName')
	...
	public function testHas() {
		...
		$cache = new ApcCache('foo');
		$this
				->assertFalse($cache->has('bar'),
						'->has() returns false when there is no entry');
	...
	public function testRead() {
		...
		$this
				->assertInstanceOf(
						'Symfony\\Component\\Validator\\Mapping\\ClassMetadata',
						$cache->read('bar'), '->read() returns metadata');
	}
}
