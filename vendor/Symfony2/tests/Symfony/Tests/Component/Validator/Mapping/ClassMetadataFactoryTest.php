...
class ClassMetadataFactoryTest extends \PHPUnit_Framework_TestCase {
	...
	public function testLoadClassMetadata() {
		...
		$constraints = array(
				new ConstraintA(
						array('groups' => array('Default', 'EntityParent'))),);
	...
	public function testMergeParentConstraints() {
		...
		$constraints = array(
				...
				new ConstraintA(
						array(
								'groups' => array('Default', 'EntityInterface',
										'Entity',))),
				new ConstraintA(
						array(
	...
	public function testWriteMetadataToCache() {
		...
		$cache->expects($this->once())->method('read')
	...
	public function testReadMetadataFromCache() {
		...
		$this
				->assertEquals($metadata,
						$factory->getClassMetadata(self::PARENTCLASS));
	}
}
