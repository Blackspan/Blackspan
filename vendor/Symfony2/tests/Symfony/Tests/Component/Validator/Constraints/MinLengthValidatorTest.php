...
class MinLengthValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testExpectsStringCompatibleType() {
		...
		$this->validator
				->isValid(new \stdClass(), new MinLength(array('limit' => 5)));
	}
	...
	public function getValidValues() {
		return array(array(123456), array('123456'),
	...
	public function getInvalidValues() {
		return array(array(12345), array('12345'),
	...
	public function testMessageIsSet() {
		$constraint = new MinLength(
				array('limit' => 5, 'message' => 'myMessage'));
		...
		$this
				->assertEquals($this->validator->getMessageParameters(),
						array('{{ value }}' => '1234', '{{ limit }}' => 5,));
	}

	public function testConstraintGetDefaultOption() {
		$constraint = new MinLength(array('limit' => 5,));
