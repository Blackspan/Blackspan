...
class UrlValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function getValidUrls() {
		return array(array('http://a.pl'), array('http://www.google.com'),
				array('http://www.google.museum'),
				array('https://google.com/'), array('https://google.com:80/'),
				...
				array('http://127.0.0.1/'), array('http://127.0.0.1:80/'),
				array('http://[::1]/'), array('http://[::1]:80/'),
				array('http://[1:2:3::4:5:6:7]/'),
				array('http://sãopaulo.com/'),
				array('http://sãopaulo.com.br/'),
				array('http://пример.испытание/'),
				array('http://مثال.إختبار/'), array('http://例子.测试/'),
				array('http://例子.測試/'), array('http://例え.テスト/'),
				array('http://مثال.آزمایشی/'), array('http://실례.테스트/'),
				array('http://العربية.idn.icann.org/'), array('http://☎.com/'),);
	}
	...
	public function getInvalidUrls() {
		return array(array('google.com'), array('://google.com'),
				array('http ://google.com'), array('http:/google.com'),
				array('http://goog_le.com'), array('http://google.com::aa'),
				array('http://google.com:aa'), array('ftp://google.fr'),
				array('faked://google.fr'), array('http://127.0.0.1:aa/'),
				array('ftp://[::1]/'), array('http://[::1'),);
	}
	...
	public function testCustomProtocolIsValid($url) {
		$constraint = new Url(
				array('protocols' => array('ftp', 'file', 'git')));

		$this->assertTrue($this->validator->isValid($url, $constraint));
	}

	public function getValidCustomUrls() {
		return array(array('ftp://google.com'), array('file://127.0.0.1'),
				array('git://[::1]/'),);
	}
