...
class IpValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function getValidIpsV4() {
		return array(array('0.0.0.0'), array('10.0.0.0'),
				array('123.45.67.178'), array('172.16.0.0'),
				array('192.168.1.0'), array('224.0.0.1'),
				array('255.255.255.255'), array('127.0.0.0'),);
	}
	...
	public function getValidIpsV6() {
		return array(array('2001:0db8:85a3:0000:0000:8a2e:0370:7334'),
				...
				array('fe80::202:b3ff:fe1e:8329'), array('0:0:0:0:0:0:0:0'),
				array('::'), array('0::'), array('::0'), array('0::0'),
				// IPv4 mapped to IPv6
				array('2001:0db8:85a3:0000:0000:8a2e:0.0.0.0'),
				array('::0.0.0.0'), array('::255.255.255.255'),
				array('::123.45.67.178'),);
	}
	...
	public function getInvalidIpsV4() {
		return array(array('0'), array('0.0'), array('0.0.0'),
				array('256.0.0.0'), array('0.256.0.0'), array('0.0.256.0'),
				array('0.0.0.256'), array('-1.0.0.0'), array('foobar'),);
	}
	...
	public function getInvalidPrivateIpsV4() {
		return array(array('10.0.0.0'), array('172.16.0.0'),
				array('192.168.1.0'),);
	}
	...
	public function getInvalidReservedIpsV4() {
		return array(array('0.0.0.0'), array('224.0.0.1'),
	...
	public function getInvalidPublicIpsV4() {
		return array_merge($this->getInvalidPrivateIpsV4(),
				$this->getInvalidReservedIpsV4());
	}
	...
	public function getInvalidIpsV6() {
		return array(array('z001:0db8:85a3:0000:0000:8a2e:0370:7334'),
				array('fe80'), array('fe80:8329'),
				array('fe80:::202:b3ff:fe1e:8329'),
				array('fe80::202:b3ff::fe1e:8329'),
				// IPv4 mapped to IPv6
				array('2001:0db8:85a3:0000:0000:8a2e:0370:0.0.0.0'),
				array('::0.0'), array('::0.0.0'), array('::256.0.0.0'),
				array('::0.256.0.0'), array('::0.0.256.0'),
				array('::0.0.0.256'),);
	}
	...
	public function getInvalidPrivateIpsV6() {
		return array(array('fdfe:dcba:9876:ffff:fdc6:c46b:bb8f:7d4c'),
				array('fdc6:c46b:bb8f:7d4c:fdc6:c46b:bb8f:7d4c'),
				array('fdc6:c46b:bb8f:7d4c:0000:8a2e:0370:7334'),);
	}
	...
	public function getInvalidPublicIpsV6() {
		return array_merge($this->getInvalidPrivateIpsV6(),
				$this->getInvalidReservedIpsV6());
	}
	...
	public function getInvalidReservedIpsAll() {
		return array_merge($this->getInvalidReservedIpsV4(),
				$this->getInvalidReservedIpsV6());
	}
	...
	public function getInvalidPublicIpsAll() {
		return array_merge($this->getInvalidPublicIpsV4(),
				$this->getInvalidPublicIpsV6());
	}

	public function testMessageIsSet() {
		$constraint = new Ip(
				array('message' => 'myMessage'));

		$this->assertFalse($this->validator->isValid('foobar', $constraint));
		$this
				->assertEquals($this->validator->getMessageTemplate(),
						'myMessage');
		$this
				->assertEquals($this->validator->getMessageParameters(),
						array('{{ value }}' => 'foobar',));
	}
}
