...
class ChoiceValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testExpectArrayIfMultipleIsTrue() {
		$constraint = new Choice(
				array('choices' => array('foo', 'bar'), 'multiple' => true,));
	...
	public function testValidCallbackExpected() {
		...
		$this->validator
				->isValid('foobar', new Choice(array('callback' => 'abcd')));
	}
	...
	public function testValidChoiceCallbackFunction() {
		$constraint = new Choice(
				array('callback' => __NAMESPACE__ . '\choice_callback'));
	...
	public function testMultipleChoices() {
		$constraint = new Choice(
				array('choices' => array('foo', 'bar', 'baz'),
						'multiple' => true,));

		$this
				->assertTrue(
						$this->validator
								->isValid(array('baz', 'bar'), $constraint));
	}

	public function testInvalidChoice() {
		$constraint = new Choice(
				array('choices' => array('foo', 'bar'),
						'message' => 'myMessage',));
	...
	public function testInvalidChoiceMultiple() {
		$constraint = new Choice(
				array('choices' => array('foo', 'bar'),
						'multipleMessage' => 'myMessage', 'multiple' => true,));

		$this
				->assertFalse(
						$this->validator
								->isValid(array('foo', 'baz'), $constraint));
		$this
				->assertEquals($this->validator->getMessageTemplate(),
						'myMessage');
		$this
	...
	public function testTooFewChoices() {
		$constraint = new Choice(
				array('choices' => array('foo', 'bar', 'moo', 'maa'),
						'multiple' => true, 'min' => 2,
	...
	public function testStrictIsFalse() {
		$constraint = new Choice(
				array('choices' => array(1, 2), 'strict' => false,));
	...
	public function testStrictIsTrue() {
		$constraint = new Choice(
				array('choices' => array(1, 2), 'strict' => true,));
	...
	public function testStrictIsFalseWhenMultipleChoices() {
		$constraint = new Choice(
				array('choices' => array(1, 2, 3), 'multiple' => true,
						'strict' => false));
