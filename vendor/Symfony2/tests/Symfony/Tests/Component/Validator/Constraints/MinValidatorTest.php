...
class MinValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testNullIsValid() {
		$this
				->assertTrue(
						$this->validator
								->isValid(null, new Min(array('limit' => 10))));
	}
	...
	public function getValidValues() {
		return array(array(10.00001), array('10.00001'), array(10), array(10.0),);
	}
	...
	public function getInvalidValues() {
		return array(array(9.999999), array('9.999999'), array(new \stdClass()),);
	}

	public function testMessageIsSet() {
		$constraint = new Min(
				array('limit' => 10, 'message' => 'myMessage'));
