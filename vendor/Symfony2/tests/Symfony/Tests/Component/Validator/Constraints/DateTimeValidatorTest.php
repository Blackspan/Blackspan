...
class DateTimeValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testDateTimeClassIsValid() {
		$this
				->assertTrue(
						$this->validator
								->isValid(new \DateTime(), new DateTime()));
	}
	...
	public function getValidDateTimes() {
		return array(array('2010-01-01 01:02:03'),
				array('1955-12-12 00:00:00'), array('2030-05-31 23:59:59'),);
	}
	...
	public function getInvalidDateTimes() {
		return array(array('foobar'), array('2010-01-01'), array('00:00:00'),
				array('2010-01-01 00:00'), array('2010-13-01 00:00:00'),
				array('2010-04-32 00:00:00'), array('2010-02-29 00:00:00'),
				array('2010-01-01 24:00:00'), array('2010-01-01 00:60:00'),
