...
class MaxValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	public function testNullIsValid() {
		$this
				->assertTrue(
						$this->validator
								->isValid(null, new Max(array('limit' => 10))));
	}
	...
	public function getValidValues() {
		return array(array(9.999999), array(10), array(10.0), array('10'),);
	}
	...
	public function getInvalidValues() {
		return array(array(10.00001), array('10.00001'), array(new \stdClass()),);
	}
