...
class ValidatorTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->validator = new Validator($this->factory,
	...
	public function testValidate_defaultGroup() {
		...
		$metadata
				->addPropertyConstraint('lastName',
		...
		$violations
				->add(
						new ConstraintViolation('', array(), $entity,
								'firstName', ''));
	...
	public function testValidate_oneGroup() {
		...
		$this
				->assertEquals($violations,
						$this->validator->validate($entity, 'Custom'));
	}
	...
	public function testValidatePropertyValue() {
		...
		$result = $this->validator
				->validatePropertyValue(get_class($entity), 'firstName',
						'Bernhard');
	...
	public function testValidateValue() {
		$result = $this->validator
				->validateValue('Bernhard', new FailingConstraint());
