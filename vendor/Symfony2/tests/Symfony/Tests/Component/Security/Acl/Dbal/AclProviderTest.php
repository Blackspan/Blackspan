...
class AclProviderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testFindAcls() {
		...
		$this
				->assertInstanceOf(
						...
						$acl0 = $acls->offsetGet($oids[0]));
		$this
				->assertInstanceOf(
						'Symfony\Component\Security\Acl\Domain\Acl',
						$acl1 = $acls->offsetGet($oids[1]));
	...
	protected function getEntryData() {
		...
		return array(array(1, 1, 1, null, 0, 1, 1, 1, 'all', 1, 1),
	...
	protected function getOidData() {
		...
		return array(array(1, 1, '123', null, 1), array(2, 2, '123', 1, 1),
				array(3, 2, 'i:3:123', 1, 1), array(4, 3, '1', 2, 1),
				array(5, 3, '2', 2, 1),);
	}

	protected function getOidAncestorData() {
		return array(array(1, 1), array(2, 1), array(2, 2), array(3, 1),
				array(3, 3), array(4, 2), array(4, 1), array(4, 4),
				array(5, 2), array(5, 1), array(5, 5),);
	}

	protected function getSidData() {
		return array(array(1, 'SomeClass-john.doe', 1),
				array(2, 'MyClass-john.doe@foo.com', 1),
				array(3, 'FooClass-123', 1), array(4, 'MooClass-ROLE_USER', 1),
				array(5, 'ROLE_USER', 0),
				array(6, 'IS_AUTHENTICATED_FULLY', 0),);
	}

	protected function getClassData() {
		return array(array(1, 'Bundle\SomeVendor\MyBundle\Entity\SomeEntity'),
