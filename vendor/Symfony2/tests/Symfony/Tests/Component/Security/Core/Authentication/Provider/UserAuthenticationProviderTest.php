...
class UserAuthenticationProviderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testAuthenticateWhenUsernameIsNotFound() {
		...
		$provider->expects($this->once())->method('retrieveUser')
				->will(
						$this
								->throwException(
										$this
	...
	public function testAuthenticateWhenPreChecksFails() {
		...
		$userChecker->expects($this->once())->method('checkPreAuth')
				->will(
						$this
								->throwException(
										$this
						...
						$this
								->returnValue(
										$this
												->getMock(
														'Symfony\Component\Security\Core\User\UserInterface')));
		$provider->expects($this->once())->method('checkAuthentication')
				->will(
						$this
								->throwException(
										$this
	...
	protected function getSupportedToken() {
		$mock = $this
				->getMock(
						'Symfony\Component\Security\Core\Authentication\Token\UsernamePasswordToken',
						array('getCredentials', 'getProviderKey'), array(), '',
						false);
