...
class DaoAuthenticationProviderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testRetrieveUser() {
		...
		$this
				->assertSame($user,
						$method
								->invoke($provider, 'fabien',
										$this->getSupportedToken()));
	}
	...
	public function testCheckAuthenticationDoesNotReauthenticateWhenPasswordHasChanged() {
		...
		$dbUser = $this
				->getMock('Symfony\Component\Security\Core\User\UserInterface');
		$dbUser->expects($this->once())->method('getPassword')
	...
	protected function getSupportedToken() {
		$mock = $this
				->getMock(
						...
						array('getCredentials', 'getUser', 'getProviderKey'),
						array(), '', false);
		$mock->expects($this->any())->method('getProviderKey')
	...
	protected function getProvider($user = false, $userChecker = false,
		...
		return new DaoAuthenticationProvider($userProvider, $userChecker,
				'key', $encoderFactory);
	}
}
