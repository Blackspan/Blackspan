...
class UserCheckerTest extends \PHPUnit_Framework_TestCase {
	...
	public function testCheckPreAuthPass() {
		...
		$account->expects($this->once())->method('isCredentialsNonExpired')
	...
	public function testCheckPostAuthPass() {
		...
		$account = $this
				->getMock(
						'Symfony\Component\Security\Core\User\AdvancedUserInterface');
		$account->expects($this->once())->method('isAccountNonLocked')
				->will($this->returnValue(true));
		$account->expects($this->once())->method('isEnabled')
				->will($this->returnValue(true));
		$account->expects($this->once())->method('isAccountNonExpired')
				->will($this->returnValue(true));
