...
class AbstractRememberMeServicesTest extends \PHPUnit_Framework_TestCase {
	public function testGetRememberMeParameter() {
		$service = $this
				->getService(null, array('remember_me_parameter' => 'foo'));
	...
	public function testAutoLoginThrowsExceptionWhenImplementationDoesNotReturnUserInterface() {
		...
		$service->expects($this->once())->method('processAutoLoginCookie')
	...
	public function testLoginSuccessIsNotProcessedWhenTokenDoesNotContainUserInterfaceImplementation() {
		...
		$service->expects($this->never())->method('onLoginSuccess');
	...
	public function testLoginSuccessIsNotProcessedWhenRememberMeIsNotRequested() {
		$service = $this
				->getService(null,
						array('name' => 'foo', 'always_remember_me' => false,
	...
	public function testLoginSuccessWhenRememberMeAlwaysIsTrue() {
		...
		$service->expects($this->once())->method('onLoginSuccess')
				->will($this->returnValue(null));
	 ...
	 */
	public function testLoginSuccessWhenRememberMeParameterWithPathIsPositive(
			$value) {
		$service = $this
				->getService(null,
						array('name' => 'foo', 'always_remember_me' => false,
								'remember_me_parameter' => 'foo[bar]'));
	...
	public function getPositiveRememberMeParameterValues() {
		return array(array('true'), array('1'), array('on'), array('yes'),);
	}
	...
	protected function getService($userProvider = null, $options = array(),
		...
		return $this
				->getMockForAbstractClass(
						...
						array(array($userProvider), 'fookey', 'fookey',
								$options, $logger));
	}
