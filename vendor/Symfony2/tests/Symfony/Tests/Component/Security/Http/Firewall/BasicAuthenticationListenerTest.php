...
class BasicAuthenticationListenerTest extends \PHPUnit_Framework_TestCase {
	public function testHandleWithValidUsernameAndPasswordServerParameters() {
		$request = new Request(array(), array(), array(), array(), array(),
				array('PHP_AUTH_USER' => 'TheUsername',
		...
		$listener = new BasicAuthenticationListener($context,
				$authenticationManager, 'TheProviderKey',
				$this
						->getMock(
	...
	public function testHandleWhenAuthenticationFails() {
		...
		$authenticationEntryPoint = $this
				->getMock(
						'Symfony\Component\Security\Http\EntryPoint\AuthenticationEntryPointInterface');
		$authenticationEntryPoint->expects($this->any())->method('start')
		...
		$listener = new BasicAuthenticationListener($context,
				...
				'TheProviderKey', $authenticationEntryPoint);
	...
	public function testHandleWithNoUsernameServerParameter() {
		...
		$context = $this
				->getMock(
						'Symfony\Component\Security\Core\SecurityContextInterface');
		$context->expects($this->never())->method('getToken');
	...
	public function testHandleWithASimilarAuthenticatedToken() {
		...
		$token = new UsernamePasswordToken('TheUsername', 'ThePassword',
				'TheProviderKey', array('ROLE_FOO'));
