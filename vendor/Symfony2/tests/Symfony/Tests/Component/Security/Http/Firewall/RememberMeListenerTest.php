...
class RememberMeListenerTest extends \PHPUnit_Framework_TestCase {
	public function testOnCoreSecurityDoesNotTryToPopulateNonEmptySecurityContext() {
		...
		$context->expects($this->never())->method('setToken');
	...
	public function testOnCoreSecurityDoesNothingWhenNoCookieIsSet() {
		...
		$service->expects($this->once())->method('autoLogin')
				->will($this->returnValue(null));
	...
	public function testOnCoreSecurityIgnoresAuthenticationExceptionThrownByAuthenticationManagerImplementation() {
		...
		$service->expects($this->once())->method('loginFail');
	...
	protected function getListener() {
		$listener = new RememberMeListener($context = $this->getContext(),
				$service = $this->getService(), $manager = $this->getManager(),
