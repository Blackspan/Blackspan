...
class DialogHelperTest extends \PHPUnit_Framework_TestCase {
	public function testAsk() {
		...
		$this
				->assertEquals('2PM',
						$dialog
								->ask($this->getOutputStream(),
										'What time is it?', '2PM'));
		$this
				->assertEquals('8AM',
						$dialog
								->ask($output = $this->getOutputStream(),
										'What time is it?', '2PM'));
	...
	public function testAskConfirmation() {
		...
		$this
				->assertTrue(
						$dialog
								->askConfirmation($this->getOutputStream(),
	...
	public function testAskAndValidate() {
		...
		$this
				->assertEquals('white',
						$dialog
								->askAndValidate($this->getOutputStream(),
										$question, $validator, 2, 'white'));
		$this
				->assertEquals('black',
						$dialog
								->askAndValidate($this->getOutputStream(),
