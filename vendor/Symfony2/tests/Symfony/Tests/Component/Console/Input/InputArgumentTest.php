...
class InputArgumentTest extends \PHPUnit_Framework_TestCase {
	public function testConstructor() {
		...
		try {
			...
			$this
					->assertEquals(
							'Argument mode "ANOTHER_ONE" is not valid.',
							$e->getMessage());
		}
	}
	...
	public function testGetDescription() {
		...
		$this
				->assertEquals('Some description', $argument->getDescription(),
	...
	public function testGetDefault() {
		$argument = new InputArgument('foo', InputArgument::OPTIONAL, '',
				'default');
		$this
				->assertEquals('default', $argument->getDefault(),
	...
	public function testSetDefault() {
		...
		$this
				->assertEquals(array(1, 2), $argument->getDefault(),
						'->setDefault() changes the default value');
		...
		try {
			...
			$this
					->fail(
							'->setDefault() throws an Exception if you give a default value for a required argument');
		} catch (\Exception $e) {
			$this
					->assertInstanceOf('\Exception', $e,
		...
		try {
			...
			$this
					->fail(
							'->setDefault() throws an Exception if you give a default value which is not an array for a IS_ARRAY option');
		} catch (\Exception $e) {
			$this
					->assertInstanceOf('\Exception', $e,
							'->setDefault() throws an Exception if you give a default value which is not an array for a IS_ARRAY option');
