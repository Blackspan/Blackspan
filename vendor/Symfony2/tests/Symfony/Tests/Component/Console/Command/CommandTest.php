...
class CommandTest extends \PHPUnit_Framework_TestCase {
	...
	public function testConstructor() {
		try {
			...
			$this
					->fail(
							'__construct() throws a \LogicException if the name is null');
		} catch (\Exception $e) {
			$this
					->assertInstanceOf('\LogicException', $e,
							'__construct() throws a \LogicException if the name is null');
			$this
					->assertEquals('The command name cannot be empty.',
							$e->getMessage(),
							'__construct() throws a \LogicException if the name is null');
		}
		$command = new Command('foo:bar');
		$this
				->assertEquals('foo:bar', $command->getName(),
	...
	public function testSetApplication() {
		...
		$this
				->assertEquals($application, $command->getApplication(),
	...
	public function testSetGetDefinition() {
		...
		$this
				->assertEquals($command, $ret,
						'->setDefinition() implements a fluent interface');
		$this
				->assertEquals($definition, $command->getDefinition(),
						'->setDefinition() sets the current InputDefinition instance');
		$command
				->setDefinition(
						array(new InputArgument('foo'), new InputOption('bar')));
		$this
				->assertTrue($command->getDefinition()->hasArgument('foo'),
						'->setDefinition() also takes an array of InputArguments and InputOptions as an argument');
		$this
				->assertTrue($command->getDefinition()->hasOption('bar'),
						'->setDefinition() also takes an array of InputArguments and InputOptions as an argument');
	...
	public function testAddOption() {
		...
		$this
				->assertTrue($command->getDefinition()->hasOption('foo'),
	...
	public function testGetNamespaceGetNameSetName() {
		$command = new \TestCommand();
		$this
				->assertEquals('namespace:name', $command->getName(),
		...
		$this
				->assertEquals('foobar:bar', $command->getName(),
						'->setName() sets the command name');
		...
		try {
			...
			$this
					->fail(
							'->setName() throws an \InvalidArgumentException if the name is empty');
		} catch (\Exception $e) {
			$this
					->assertInstanceOf('\InvalidArgumentException', $e,
							'->setName() throws an \InvalidArgumentException if the name is empty');
			$this
					->assertEquals('Command name "" is invalid.',
							$e->getMessage(),
							'->setName() throws an \InvalidArgumentException if the name is empty');
		}
		...
		try {
			...
			$this
					->assertInstanceOf('\InvalidArgumentException', $e,
							'->setName() throws an \InvalidArgumentException if the name is empty');
			$this
					->assertEquals('Command name "foo:" is invalid.',
							$e->getMessage(),
							'->setName() throws an \InvalidArgumentException if the name is empty');
		}
	}
	...
	public function testGetSetDescription() {
		...
		$this
				->assertEquals('description1', $command->getDescription(),
	...
	public function testGetSetHelp() {
		...
		$this
				->assertEquals('help1', $command->getHelp(),
	...
	public function testGetSetAliases() {
		$command = new \TestCommand();
		$this
				->assertEquals(array('name'), $command->getAliases(),
		...
		$this
				->assertEquals(array('name1'), $command->getAliases(),
	...
	public function testGetSynopsis() {
		...
		$this
				->assertEquals('namespace:name [--foo] [foo]',
						$command->getSynopsis(),
	...
	public function testGetHelper() {
		...
		$this
				->assertEquals($formatterHelper->getName(),
	...
	public function testMergeApplicationDefinition() {
		...
		$application1->getDefinition()
				->addOptions(array(new InputOption('bar')));
		$command = new \TestCommand();
		$command->setApplication($application1);
		$command
				->setDefinition(
						$definition = new InputDefinition(
								array(new InputArgument('bar'),
										new InputOption('foo'))));
		...
		$this
				->assertTrue($command->getDefinition()->hasArgument('bar'),
						'->mergeApplicationDefinition() merges the application arguments and the command arguments');
		$this
				->assertTrue($command->getDefinition()->hasOption('foo'),
	...
	public function testRun() {
		...
		try {
			...
			$this
					->fail(
							'->run() throws a \InvalidArgumentException when the input does not validate the current InputDefinition');
		} catch (\Exception $e) {
			$this
					->assertInstanceOf('\InvalidArgumentException', $e,
							'->run() throws a \InvalidArgumentException when the input does not validate the current InputDefinition');
		...
		$this
				->assertEquals(
						'interact called' . PHP_EOL . 'execute called'
		...
		$this
				->assertEquals('execute called' . PHP_EOL,
						$tester->getDisplay(),
		...
		try {
			...
			$this
					->fail(
							'->run() throws a \LogicException if the execute() method has not been overridden and no code has been provided');
		} catch (\Exception $e) {
			$this
					->assertInstanceOf('\LogicException', $e,
							'->run() throws a \LogicException if the execute() method has not been overridden and no code has been provided');
	...
	public function testSetCode() {
		...
		$this
				->assertEquals(
						'interact called' . PHP_EOL . 'from the code...'
								. PHP_EOL, $tester->getDisplay());
	}
	...
	public function testAsText() {
		...
		$this
				->assertStringEqualsFile(
						self::$fixturesPath . '/command_astext.txt',
						$command->asText(),
	...
	public function testAsXml() {
		...
		$this
				->assertXmlStringEqualsXmlFile(
						self::$fixturesPath . '/command_asxml.txt',
						$command->asXml(),
