...
class ApplicationTesterTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->application->register('foo')->addArgument('command')
				->addArgument('foo')
				->setCode(
	...
	public function testRun() {
		$this
				->assertFalse($this->tester->getInput()->isInteractive(),
						'->execute() takes an interactive option');
		$this
				->assertFalse($this->tester->getOutput()->isDecorated(),
	...
	public function testGetDisplay() {
		$this
				->assertEquals('foo' . PHP_EOL, $this->tester->getDisplay(),
