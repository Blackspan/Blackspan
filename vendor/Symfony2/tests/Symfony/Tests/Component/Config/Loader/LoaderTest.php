...
class LoaderTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetSetResolver() {
		...
		$this
				->assertSame($resolver, $loader->getResolver(),
	...
	public function testResolve() {
		...
		$loader1->expects($this->once())->method('supports')
		...
		$this
				->assertSame($loader, $loader->resolve('foo.foo'),
						'->resolve() finds a loader');
		$this
				->assertSame($loader1, $loader->resolve('foo.xml'),
						'->resolve() finds a loader');
		...
		try {
			...
			$this
					->fail(
							'->resolve() throws a FileLoaderLoadException if the resource cannot be loaded');
...
class ProjectLoader1 extends Loader {
	...
	public function supports($resource, $type = null) {
		return is_string($resource)
				&& 'foo' === pathinfo($resource, PATHINFO_EXTENSION);
	}
