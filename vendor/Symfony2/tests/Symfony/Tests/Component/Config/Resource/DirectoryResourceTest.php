...
class DirectoryResourceTest extends \PHPUnit_Framework_TestCase {
	...
	public function testGetResource() {
		...
		$this
				->assertEquals($this->directory, $resource->getResource(),
	...
	public function testIsFreshUpdateFile() {
		...
		$this
				->assertFalse($resource->isFresh(time() + 10),
	...
	public function testIsFreshCreateFileInSubdirectory() {
		...
		$this
				->assertTrue($resource->isFresh(time() + 10),
						'->isFresh() returns true if an unmodified subdirectory exists');
	...
	public function testFilterRegexListNoMatch() {
		...
		$this
				->assertTrue($resource->isFresh(time() + 10),
						'->isFresh() returns true if a new file not matching the filter regex is created');
	}
