...
class TreeBuilderTest extends \PHPUnit_Framework_TestCase {
	public function testUsingACustomNodeBuilder() {
		...
		$this
				->assertEquals(get_class($nodeBuilder),
						'Symfony\Tests\Component\Config\Definition\Builder\NodeBuilder');
	...
	public function testOverrideABuiltInNodeType() {
		...
		$this
				->assertEquals(get_class($definition),
						'Symfony\Tests\Component\Config\Definition\Builder\VariableNodeDefinition');
	}
	...
	public function testAddANodeType() {
		...
		$this
				->assertEquals(get_class($definition),
						'Symfony\Tests\Component\Config\Definition\Builder\BarNodeDefinition');
	}
	...
	public function testAnExtendedNodeBuilderGetsPropagatedToTheChildren() {
		...
		$builder->root('propagation')->children()
				->setNodeClass('extended',
						'Symfony\Tests\Component\Config\Definition\Builder\VariableNodeDefinition')
				->node('foo', 'extended')->end()->arrayNode('child')
				->children()->node('foo', 'extended')->end()->end()->end()
				->end();
	}
}
