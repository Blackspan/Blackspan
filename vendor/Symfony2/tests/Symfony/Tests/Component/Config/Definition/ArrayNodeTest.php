...
class ArrayNodeTest extends \PHPUnit_Framework_TestCase {
	...
	public function testExceptionThrownOnUnrecognizedChild() {
		...
		try {
			...
			$this
					->fail(
							'An exception should have been throw for a bad child node');
		} catch (\Exception $e) {
			$this
					->assertInstanceOf(
							...
							$e);
			$this
					->assertEquals('Unrecognized options "foo" under "root"',
							$e->getMessage());
		}
	}
	...
	public function testIgnoreExtraKeysNoException() {
		...
		$this
				->assertTrue(true,
						'No exception was thrown when setIgnoreExtraKeys is true');
	}
}
