...
class DateTimeToStringTransformerTest extends DateTimeTestCase {
	public function testTransform() {
		$transformer = new DateTimeToStringTransformer('UTC', 'UTC',
				'Y-m-d H:i:s');
	...
	public function testTransformRandomFormat($format, $datetime) {
		...
		$this
				->assertEquals($output->format($format),
	...
	public function testTransform_differentTimezones() {
		$transformer = new DateTimeToStringTransformer('Asia/Hong_Kong',
				'America/New_York', 'Y-m-d H:i:s');
	...
	public function testReverseTransform() {
		$reverseTransformer = new DateTimeToStringTransformer('UTC', 'UTC',
				'Y-m-d H:i:s');
		...
		$this
				->assertDateTimeEquals($output,
						$reverseTransformer->reverseTransform($input));
	}
	...
	public function getFormatAndDateTime() {
		return array(array('Y-m-d H:i:s', '2010-02-03 04:05:06 UTC'),
	...
	public function testReverseTransform_differentTimezones() {
		$reverseTransformer = new DateTimeToStringTransformer(
				'America/New_York', 'Asia/Hong_Kong', 'Y-m-d H:i:s');
