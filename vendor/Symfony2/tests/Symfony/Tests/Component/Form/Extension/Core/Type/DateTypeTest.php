...
class DateTypeTest extends LocalizedTestCase {
	...
	public function testInvalidInputOption() {
		$form = $this->factory
				->create('date', null,
						array('input' => 'fake_input',));
	}

	public function testSubmitFromSingleTextDateTime() {
		$form = $this->factory
				->create('date', null,
						array('data_timezone' => 'UTC',
								'user_timezone' => 'UTC',
								'widget' => 'single_text',
								'input' => 'datetime',));
		...
		$this
				->assertDateTimeEquals(new \DateTime('2010-06-02 UTC'),
						$form->getData());
	...
	public function testSubmitFromSingleTextRaw() {
		$form = $this->factory
				->create('date', null,
						array('data_timezone' => 'UTC',
								'user_timezone' => 'UTC',
								'widget' => 'single_text', 'input' => 'array',));

		$form->bind('2.6.2010');

		$output = array('day' => '2', 'month' => '6', 'year' => '2010',);
	...
	public function testSubmitFromText() {
		$form = $this->factory
				->create('date', null,
						array('data_timezone' => 'UTC',
								'user_timezone' => 'UTC', 'widget' => 'text',));

		$text = array('day' => '2', 'month' => '6', 'year' => '2010',);
	...
	public function testSubmitFromChoice() {
		$form = $this->factory
				->create('date', null,
						array('data_timezone' => 'UTC',
								'user_timezone' => 'UTC', 'widget' => 'choice',));
	...
	public function testFormatOptionCustomPatternCollapsingIntlDateFormatterConstant() {
		$form = $this->factory
				->create('date', null,
						array('format' => '0', 'widget' => 'single_text',
								'input' => 'string',));
		...
		$this
				->assertNotEquals('Mittwoch, 02. Juni 2010',
						$form->getClientData());
	}
	...
	public function testSetData_differentTimezones() {
		$form = $this->factory
				->create('date', null,
						array('data_timezone' => 'America/New_York',
	...
	public function testYearsOption() {
		$form = $this->factory
				->create('date', null,
						array('years' => array(2010, 2011),));

		$view = $form->createView();

		$this
				->assertSame(array(2010 => '2010', 2011 => '2011'),
	...
	public function testMonthsOption() {
		$form = $this->factory
				->create('date', null,
						array('months' => array(6, 7),));

		$view = $form->createView();

		$this
				->assertSame(array(6 => '06', 7 => '07'),
	...
	public function testPassDatePatternToView() {
		...
		$this
				->assertSame('{{ day }}.{{ month }}.{{ year }}',
						$view->get('date_pattern'));
	}

	public function testPassDatePatternToViewDifferentPattern() {
		$form = $this->factory
				->create('date', null,
						array('format' => 'MM*yyyy*dd'));

		$view = $form->createView();

		$this
				->assertSame('{{ month }}*{{ year }}*{{ day }}',
						$view->get('date_pattern'));
	}
