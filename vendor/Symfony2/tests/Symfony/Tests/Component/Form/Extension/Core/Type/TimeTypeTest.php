...
class TimeTypeTest extends LocalizedTestCase {
	...
	public function testSubmit_string() {
		$form = $this->factory
				->create('time', null,
						array('data_timezone' => 'UTC',
								'user_timezone' => 'UTC', 'input' => 'string',));
	...
	public function testSubmit_arraySingleTextWithSeconds() {
		...
		$data = array('hour' => '3', 'minute' => '4', 'second' => '5',);
	...
	public function testSetData_withSeconds() {
		$form = $this->factory
				->create('time', null,
						array('data_timezone' => 'UTC',
								'user_timezone' => 'UTC',
								'input' => 'datetime', 'with_seconds' => true,));

		$form->setData(new \DateTime('03:04:05 UTC'));

		$this
				->assertEquals(
						array('hour' => 3, 'minute' => 4, 'second' => 5),
						$form->getClientData());
	}
	...
	public function testSetData_differentTimezones() {
		$form = $this->factory
				->create('time', null,
						array('data_timezone' => 'America/New_York',
								...
								'input' => 'string', 'with_seconds' => true,));
		...
		$displayedData = array('hour' => (int) $outputTime->format('H'),
	...
	public function testIsSecondWithinRange_returnsTrueIfWithin() {
		$form = $this->factory
				->create('time', null,
						array('seconds' => array(6, 7), 'with_seconds' => true,));
	...
	public function testIsPartiallyFilled_returnsFalseIfCompletelyEmpty_withSeconds() {
		...
		$form = $this->factory
				->create('time', null,
						array('widget' => 'choice', 'with_seconds' => true,));
	...
	public function testIsPartiallyFilled_returnsFalseIfCompletelyFilled_withSeconds() {
		...
		$form
				->bind(
						array('hour' => '0', 'minute' => '0', 'second' => '0',));
