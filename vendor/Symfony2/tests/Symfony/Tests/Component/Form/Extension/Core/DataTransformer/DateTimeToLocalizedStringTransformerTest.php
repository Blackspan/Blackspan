...
class DateTimeToLocalizedStringTransformerTest extends DateTimeTestCase {
	...
	public static function assertEquals($expected, $actual, $message = '',
			$delta = 0, $maxDepth = 10, $canonicalize = FALSE,
			$ignoreCase = FALSE) {
	...
	public function testTransformShortDate() {
		...
		$this
				->assertEquals('03.02.10 04:05',
						$transformer->transform($this->dateTime));
	}
	...
	public function testTransformLongDate() {
		...
		$this
				->assertEquals('03. Februar 2010 04:05',
						$transformer->transform($this->dateTime));
	}
	...
	public function testTransformFullDate() {
		...
		$this
				->assertEquals('Mittwoch, 03. Februar 2010 04:05',
						$transformer->transform($this->dateTime));
	}

	public function testTransformShortTime() {
		$transformer = new DateTimeToLocalizedStringTransformer('UTC', 'UTC',
				null, \IntlDateFormatter::SHORT);
	...
	public function testTransformMediumTime() {
		$transformer = new DateTimeToLocalizedStringTransformer('UTC', 'UTC',
				null, \IntlDateFormatter::MEDIUM);

		$this
				->assertEquals('03.02.2010 04:05:06',
						$transformer->transform($this->dateTime));
	}

	public function testTransformLongTime() {
		$transformer = new DateTimeToLocalizedStringTransformer('UTC', 'UTC',
				null, \IntlDateFormatter::LONG);

		$this
				->assertEquals('03.02.2010 04:05:06 GMT+00:00',
						$transformer->transform($this->dateTime));
	}
	...
	public function testTransformToDifferentLocale() {
		...
		$this
				->assertEquals('Feb 3, 2010 4:05 AM',
						$transformer->transform($this->dateTime));
	}
	...
	public function testTransform_differentTimezones() {
		$transformer = new DateTimeToLocalizedStringTransformer(
				'America/New_York', 'Asia/Hong_Kong');
		...
		$this
				->assertEquals($dateTime->format('d.m.Y H:i'),
	...
	public function testTransform_differentPatterns() {
		$transformer = new DateTimeToLocalizedStringTransformer('UTC', 'UTC',
				...
				\IntlDateFormatter::GREGORIAN, 'MM*yyyy*dd HH|mm|ss');

		$this
				->assertEquals('02*2010*03 04|05|06',
						$transformer->transform($this->dateTime));
	}
	...
	public function testReverseTransformShortDate() {
		...
		$this
				->assertDateTimeEquals($this->dateTimeWithoutSeconds,
						$transformer->reverseTransform('03.02.10 04:05'));
	}
	...
	public function testReverseTransformMediumDate() {
		...
		$this
				->assertDateTimeEquals($this->dateTimeWithoutSeconds,
						$transformer->reverseTransform('03.02.2010 04:05'));
	}
	...
	public function testReverseTransformLongDate() {
		...
		$this
				->assertDateTimeEquals($this->dateTimeWithoutSeconds,
						$transformer
								->reverseTransform('03. Februar 2010 04:05'));
	}
	...
	public function testReverseTransformFullDate() {
		...
		$this
				->assertDateTimeEquals($this->dateTimeWithoutSeconds,
						$transformer
								->reverseTransform(
										'Mittwoch, 03. Februar 2010 04:05'));
	}
	...
	public function testReverseTransformMediumTime() {
		...
		$this
				->assertDateTimeEquals($this->dateTime,
						$transformer->reverseTransform('03.02.2010 04:05:06'));
	}
