...
class MonthChoiceListTest extends \PHPUnit_Framework_TestCase {
	...
	protected function setUp() {
		...
		$this->formatter = new \IntlDateFormatter(\Locale::getDefault(),
				\IntlDateFormatter::SHORT, \IntlDateFormatter::NONE, 'UTC');
	}
	...
	public function testFormattedMonthsLongWithDifferentTimezone() {
		$this->formatter = new \IntlDateFormatter(\Locale::getDefault(),
				\IntlDateFormatter::SHORT, \IntlDateFormatter::NONE, 'PST');
