...
class DateTimeToArrayTransformerTest extends DateTimeTestCase {
	public function testTransform() {
		...
		$output = array('year' => '2010', 'month' => '2', 'day' => '3',
	...
	public function testTransform_empty_withFields() {
		$transformer = new DateTimeToArrayTransformer(null, null,
				array('year', 'minute', 'second'));

		$output = array('year' => '', 'minute' => '', 'second' => '',);
	...
	public function testTransform_withFields() {
		$transformer = new DateTimeToArrayTransformer('UTC', 'UTC',
				array('year', 'month', 'minute', 'second'));

		$input = new \DateTime('2010-02-03 04:05:06 UTC');

		$output = array('year' => '2010', 'month' => '2', 'minute' => '5',
				'second' => '6',);
	...
	public function testTransform_withPadding() {
		...
		$output = array('year' => '2010', 'month' => '02', 'day' => '03',
	...
	public function testTransform_differentTimezones() {
		$transformer = new DateTimeToArrayTransformer('America/New_York',
				'Asia/Hong_Kong');
		...
		$output = array('year' => (string) (int) $dateTime->format('Y'),
	...
	public function testReverseTransform() {
		...
		$input = array('year' => '2010', 'month' => '2', 'day' => '3',
				'hour' => '4', 'minute' => '5', 'second' => '6',);

		$output = new \DateTime('2010-02-03 04:05:06 UTC');

		$this
				->assertDateTimeEquals($output,
	...
	public function testReverseTransform_completelyEmpty() {
		...
		$input = array('year' => '', 'month' => '', 'day' => '', 'hour' => '',
				'minute' => '', 'second' => '',);
	...
	public function testReverseTransform_partiallyEmpty_day() {
		...
		$transformer
				->reverseTransform(
						array('year' => '2010', 'month' => '2', 'hour' => '4',
								'minute' => '5', 'second' => '6',));
	}
	...
	public function testReverseTransformWithInvalidMonth() {
		...
		$transformer
				->reverseTransform(
						array('year' => '2010', 'month' => '13', 'day' => '3',
								'hour' => '4', 'minute' => '5',
								'second' => '6',));
	}
	...
	public function testReverseTransformWithInvalidDay() {
		...
		$transformer
				->reverseTransform(
						array('year' => '2010', 'month' => '2', 'day' => '31',
								'hour' => '4', 'minute' => '5',
								'second' => '6',));
	}
	...
	public function testReverseTransformWithStringMonth() {
		...
		$transformer
				->reverseTransform(
						array('year' => '2010', 'month' => 'bazinga',
								'day' => '31', 'hour' => '4', 'minute' => '5',
								'second' => '6',));
	}
