...
class FormTest_AuthorWithoutRefSetter {
	...
	public function getReferenceCopy() {
		return is_object($this->referenceCopy) ? clone $this->referenceCopy
				: $this->referenceCopy;
	}
...
class FormTypeTest extends TypeTestCase {
		...
		$form
				->bind(
						array(
								...
								'referenceCopy' => array('firstName' => 'Foo',)));
	...
	public function testSubformCallsSettersIfReferenceIsScalar() {
		...
		$form
				->bind(
						array('referenceCopy' => array(), // doesn't matter actually
						));
	...
	public function testSubformAlwaysInsertsIntoArrays() {
		...
		$form
				->bind(
						array('referenceCopy' => array('a' => 'b'), // doesn't matter actually
						));
