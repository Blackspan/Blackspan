...
abstract class AbstractLayoutTest extends \PHPUnit_Framework_TestCase {
	...
	protected function assertXpathNodeValue(\DomElement $element, $expression,
			$nodeValue) {
			...
			$this
					->fail(
							sprintf(
									...
									$nodeList->length == 1 ? 'once'
											: $nodeList->length . ' times',
									// strip away <root> and </root>
									substr($dom->saveHTML(), 6, -8)));
		}
	}

	protected function assertWidgetMatchesXpath(FormView $view, array $vars,
			$xpath) {
	...
	abstract protected function renderWidget(FormView $view,
			array $vars = array());

	abstract protected function renderRow(FormView $view, array $vars = array());

	abstract protected function renderRest(FormView $view,
			array $vars = array());
	...
	public function testEnctype() {
		$form = $this->factory
				->createNamedBuilder('form', 'na&me', null,
						array('property_path' => 'name',))->add('file', 'file')
				->getForm();

		$this
				->assertEquals('enctype="multipart/form-data"',
						$this->renderEnctype($form->createView()));
	}

	public function testNoEnctype() {
		$form = $this->factory
				->createNamedBuilder('form', 'na&me', null,
						array('property_path' => 'name',))->add('text', 'text')
				->getForm();
	...
	public function testLabel() {
		$form = $this->factory
				->createNamed('text', 'na&me', null,
						array('property_path' => 'name',));
	...
	public function testLabelWithCustomOptionsPassedDirectly() {
		$form = $this->factory
				->createNamed('text', 'na&me', null,
						array('property_path' => 'name',));
		$html = $this
				->renderLabel($form->createView(), null,
						array(
								'attr' => array('class' => 'my&class'),));
	...
	public function testLabelWithCustomTextAndCustomOptionsPassedDirectly() {
		$form = $this->factory
				->createNamed('text', 'na&me', null,
						array('property_path' => 'name',));
		$html = $this
				->renderLabel($form->createView(), 'Custom label',
						array(
								'attr' => array('class' => 'my&class'),));
...
');
	...
	public function testCheckedCheckbox() {
		$form = $this->factory
				->createNamed('checkbox', 'na&me', true,
						array('property_path' => 'name',));

		$this
				->assertWidgetMatchesXpath($form->createView(), array(),
						'/input
    [@type="checkbox"]
    [@name="na&me"]
    [@checked="checked"]
...
');
	...
	public function testCheckedCheckboxWithValue() {
		$form = $this->factory
				->createNamed('checkbox', 'na&me', true,
						array('property_path' => 'name', 'value' => 'foo&bar',));
...
');
	...
	public function testUncheckedCheckbox() {
		$form = $this->factory
				->createNamed('checkbox', 'na&me', false,
						array('property_path' => 'name',));
...
');
	...
	public function testSingleChoice() {
		$form = $this->factory
				->createNamed('choice', 'na&me', '&a',
						array('property_path' => 'name',
								'choices' => array('&a' => 'Choice&A',
										'&b' => 'Choice&B'),
...
');
	...
	public function testSingleChoiceWithPreferred() {
		...
		$this
				->assertWidgetMatchesXpath($form->createView(),
						array('separator' => '-- sep --'),
						'/select
    [@name="na&me"]
    [@required="required"]
...
');
	...
	public function testMultipleChoice() {
		$form = $this->factory
				->createNamed('choice', 'na&me', array('&a'),
						array('property_path' => 'name',
								'choices' => array('&a' => 'Choice&A',
										'&b' => 'Choice&B'),
...
');
	...
	public function testSingleChoiceExpandedWithBooleanValue() {
		$form = $this->factory
				->createNamed('choice', 'na&me', true,
						array('property_path' => 'name',
								'choices' => array('1' => 'Choice&A',
										'0' => 'Choice&B'),
								'multiple' => false, 'expanded' => true,));
...
');
	...
	public function testMultipleChoiceExpanded() {
		$form = $this->factory
				->createNamed('choice', 'na&me', array('&a', '&c'),
						array('property_path' => 'name',
								'choices' => array('&a' => 'Choice&A',
...
');
	...
	public function testCsrf() {
		$this->csrfProvider->expects($this->any())->method('generateCsrfToken')
				->will($this->returnValue('foo&bar'));

		$form = $this->factory
				->createNamed('csrf', 'na&me', null,
						array('property_path' => 'name',));
...
');
	...
	public function testDateTime() {
		$form = $this->factory
				->createNamed('datetime', 'na&me', '2011-02-03 04:05:06',
						array('property_path' => 'name', 'input' => 'string',
								'with_seconds' => false,));
...
');
	...
	public function testDateTimeWithEmptyValueGlobal() {
		$form = $this->factory
				->createNamed('datetime', 'na&me', null,
						array('property_path' => 'name', 'input' => 'string',
...
');
	...
	public function testDateTimeWithEmptyValueOnTime() {
		$form = $this->factory
				->createNamed('datetime', 'na&me', '2011-02-03',
						array('property_path' => 'name', 'input' => 'string',
...
');
	...
	public function testDateTimeWithWidgetSingleText() {
		$form = $this->factory
				->createNamed('datetime', 'name', '2011-02-03 04:05:06',
						array('property_path' => 'name', 'input' => 'string',
								'widget' => 'single_text',));
...
');
	...
	public function testDateChoice() {
		$form = $this->factory
				->createNamed('date', 'na&me', '2011-02-03',
						array('property_path' => 'name', 'input' => 'string',
								'widget' => 'choice',));
...
');
	...
	public function testBirthDay() {
		$form = $this->factory
				->createNamed('birthday', 'na&me', '2000-02-03',
						array('property_path' => 'name', 'input' => 'string',));
...
');
	...
	public function testBirthDayWithEmptyValue() {
		$form = $this->factory
				->createNamed('birthday', 'na&me', '1950-01-01',
						array('property_path' => 'name', 'input' => 'string',
...
');
	...
	public function testEmail() {
		$form = $this->factory
				->createNamed('email', 'na&me', 'foo&bar',
						array('property_path' => 'name',));
...
');
	...
	public function testEmailWithMaxLength() {
		$form = $this->factory
				->createNamed('email', 'na&me', 'foo&bar',
						array('property_path' => 'name', 'max_length' => 123,));
...
');
	...
	public function testHidden() {
		$form = $this->factory
				->createNamed('hidden', 'na&me', 'foo&bar',
						array('property_path' => 'name',));
...
');
	...
	public function testLocale() {
		$form = $this->factory
				->createNamed('locale', 'na&me', 'de_AT',
						array('property_path' => 'name',));
...
');
	...
	public function testMoney() {
		$form = $this->factory
				->createNamed('money', 'na&me', 1234.56,
						array('property_path' => 'name', 'currency' => 'EUR',));
...
');
	...
	public function testNumber() {
		$form = $this->factory
				->createNamed('number', 'na&me', 1234.56,
						array('property_path' => 'name',));
...
');
	...
	public function testPassword() {
		$form = $this->factory
				->createNamed('password', 'na&me', 'foo&bar',
						array('property_path' => 'name',));
...
');
	...
	public function testPasswordBoundNotAlwaysEmpty() {
		$form = $this->factory
				->createNamed('password', 'na&me', null,
						array('property_path' => 'name',
								'always_empty' => false,));
		$form->bind('foo&bar');
...
');
	...
	public function testTextarea() {
		$form = $this->factory
				->createNamed('textarea', 'na&me', 'foo&bar',
						array('property_path' => 'name', 'pattern' => 'foo',));
...
');
	...
	public function testText() {
		$form = $this->factory
				->createNamed('text', 'na&me', 'foo&bar',
						array('property_path' => 'name',));
...
');
	...
	public function testSearch() {
		$form = $this->factory
				->createNamed('search', 'na&me', 'foo&bar',
						array('property_path' => 'name',));
...
');
	...
	public function testTime() {
		$form = $this->factory
				->createNamed('time', 'na&me', '04:05:06',
						array('property_path' => 'name', 'input' => 'string',
								'with_seconds' => false,));
...
');
	...
	public function testTimezone() {
		$form = $this->factory
				->createNamed('timezone', 'na&me', 'Europe/Vienna',
						array('property_path' => 'name',));
...
');
	...
	public function testTimezoneWithEmptyValue() {
		$form = $this->factory
				->createNamed('timezone', 'na&me', null,
						array('property_path' => 'name',
...
');
	...
	public function testCollectionPrototype() {
		$form = $this->factory
				->createNamedBuilder('form', 'na&me',
						array('items' => array('one', 'two', 'three')))
