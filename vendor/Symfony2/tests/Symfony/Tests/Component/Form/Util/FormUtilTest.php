...
class FormUtilTest extends \PHPUnit_Framework_TestCase {
	public function toArrayKeyProvider() {
		return array(array(0, 0), array('0', 0), array('1', 1),
				array(false, 0), array(true, 1), array('', ''),
				array(null, ''), array('1.23', '1.23'), array('foo', 'foo'),
				array('foo10', 'foo10'),);
	}
	...
	public function isChoiceGroupProvider() {
		return array(array(false, 0), array(false, '0'), array(false, '1'),
				array(false, 1), array(false, ''), array(false, null),
				array(false, true), array(true, array()),);
	}
	...
	public function testIsChoiceGroupPart2() {
		if (version_compare(PHP_VERSION, '5.3.2') <= 0) {
			$this
					->markTestSkipped(
							'PHP prior to 5.3.3 has issue with SplFixedArrays - https://bugs.php.net/bug.php?id=50481');
		}
	...
	public function isChoiceSelectedProvider() {
		return array(array(true, 0, 0), array(true, '0', 0),
				array(true, '1', 1), array(true, false, 0),
				array(true, true, 1), array(true, '', ''),
				array(true, null, ''), array(true, '1.23', '1.23'),
				array(true, 'foo', 'foo'), array(true, 'foo10', 'foo10'),
	...
	public function testIsChoiceSelected($expected, $choice, $value) {
		$this
				->assertSame($expected,
						FormUtil::isChoiceSelected($choice, $value));
	}
}
