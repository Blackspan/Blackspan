...
class RemoveUnusedDefinitionsPassTest extends \PHPUnit_Framework_TestCase {
	public function testProcess() {
		...
		$container->register('moo')->setArguments(array(new Reference('bar')));
	...
	public function testProcessRemovesUnusedDefinitionsRecursively() {
		$container = new ContainerBuilder();
		$container->register('foo')->setPublic(false);
		$container->register('bar')->setArguments(array(new Reference('foo')))
				->setPublic(false);
	...
	public function testProcessWorksWithInlinedDefinitions() {
		...
		$container->register('bar')
				->setArguments(
						array(new Definition(null, array(new Reference('foo')))));
