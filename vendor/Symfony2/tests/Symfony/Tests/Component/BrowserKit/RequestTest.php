...
class RequestTest extends \PHPUnit_Framework_TestCase {
	public function testGetUri() {
		...
		$this
				->assertEquals('http://www.example.com/', $request->getUri(),
	...
	public function testGetParameters() {
		...
		$this
				->assertEquals(array('foo' => 'bar'),
						...
						'->getParameters() returns the parameters of the request');
	}
	...
	public function testGetFiles() {
		$request = new Request('http://www.example.com/', 'get', array(),
				array('foo' => 'bar'));
		$this
				->assertEquals(array('foo' => 'bar'), $request->getFiles(),
						'->getFiles() returns the uploaded files of the request');
	}
	...
	public function testGetCookies() {
		$request = new Request('http://www.example.com/', 'get', array(),
				array(), array('foo' => 'bar'));
		$this
				->assertEquals(array('foo' => 'bar'), $request->getCookies(),
	...
	public function testGetServer() {
		...
		$this
				->assertEquals(array('foo' => 'bar'), $request->getServer(),
