...
class ClientTest extends \PHPUnit_Framework_TestCase {
	...
	public function testFilterResponseConvertsCookies() {
		...
		$response->headers
				->setCookie(
						new Cookie('foo', 'bar',
								\DateTime::createFromFormat('j-M-Y H:i:s T',
	...
	public function testUploadedFile() {
		...
		$files = array(
				array('tmp_name' => $source, 'name' => 'original',
						'type' => 'mime/original', 'size' => 123,
						'error' => UPLOAD_ERR_OK),
				new UploadedFile($source, 'original', 'mime/original', 123,
						UPLOAD_ERR_OK),);
	...
	public function testUploadedFileWhenSizeExceedsUploadMaxFileSize() {
		...
		$file = $this
				...
				->setConstructorArgs(
						array($source, 'original', 'mime/original', 123,
								UPLOAD_ERR_OK))->setMethods(array('getSize'))
				->getMock();
