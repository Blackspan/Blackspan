...
class CodeHelperTest extends \PHPUnit_Framework_TestCase {
	...
	static public function setUpBeforeClass() {
		self::$helper = new CodeHelper('txmt://open?url=file://%f&line=%l',
				'/root', 'UTF-8');
	}

	public function testFormatFile() {
		$expected = sprintf(
				'<a href="txmt://open?url=file://%s&amp;line=25" title="Click to open this file" class="file_link">%s at line 25</a>',
				__FILE__, __FILE__);
	...
	public function getClassNameProvider() {
		return array(array('F\Q\N\Foo', '<abbr title="F\Q\N\Foo">Foo</abbr>'),
				array('Bare', '<abbr title="Bare">Bare</abbr>'),);
	}

	public function getMethodNameProvider() {
		return array(
				array('F\Q\N\Foo::Method',
