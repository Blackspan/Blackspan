...
class ContainerAwareEventDispatcherTest extends \PHPUnit_Framework_TestCase {
	public function testAddAListenerService() {
		...
		$service = $this
				->getMock('Symfony\Bundle\FrameworkBundle\Tests\Service');
		...
		$dispatcher
				->addListenerService('onEvent',
						array('service.listener', 'onEvent'));
	...
	public function testPreventDuplicateListenerService() {
		...
		$dispatcher
				->addListenerService('onEvent',
						array('service.listener', 'onEvent'), 5);
		$dispatcher
				->addListenerService('onEvent',
						array('service.listener', 'onEvent'), 10);
	...
	public function testRemoveAfterDispatch() {
		...
		$dispatcher
				->removeListener('onEvent',
						array($container->get('service.listener'), 'onEvent'));
