...
class RegistryTest extends TestCase {
	public function testGetDefaultConnectionName() {
		...
		$registry = new Registry($container, array(), array(), 'default',
				'default');
	...
	public function testGetDefaultEntityManagerName() {
		...
		$this
				->assertEquals('default',
						$registry->getDefaultEntityManagerName());
	}
	...
	public function testGetUnknownConnection() {
		...
		$this
				->setExpectedException('InvalidArgumentException',
						'Doctrine Connection named "default" does not exist.');
	...
	public function testGetDefaultEntityManager() {
		...
		$registry = new Registry($container, array(),
	...
	public function testGetUnknownEntityManager() {
		...
		$this
				->setExpectedException('InvalidArgumentException',
						'Doctrine EntityManager named "default" does not exist.');
