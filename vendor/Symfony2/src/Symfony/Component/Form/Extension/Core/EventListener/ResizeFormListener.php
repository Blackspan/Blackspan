...
class ResizeFormListener implements EventSubscriberInterface {
	...
	public function __construct(FormFactoryInterface $factory, $type,
			array $options = array(), $allowAdd = false, $allowDelete = false) {
	...
	public function preSetData(DataEvent $event) {
		...
		foreach ($data as $name => $value) {
			$form
					->add(
							$this->factory
									->createNamed($this->type, $name, null,
											array_replace(
													array(
															'property_path' => '['
																	. $name
