...
class Router implements RouterInterface {
	...
	public function __construct(LoaderInterface $loader, $resource,
			array $options = array(), RequestContext $context = null,
	...
	public function setOptions(array $options) {
		$this->options = array('cache_dir' => null,
				'debug' => false,
	...
	public function setOption($key, $value) {
		if (!array_key_exists($key, $this->options)) {
			throw new \InvalidArgumentException(
					sprintf('The Router does not support the "%s" option.',
							$key));
		}
	...
	public function getMatcher() {
		...
		if (null === $this->options['cache_dir']
			...
			return $this->matcher = new $this->options['matcher_class'](
					$this->getRouteCollection(), $this->context,
					$this->defaults);
		}
		...
		if (!$cache->isFresh($class)) {
			$dumper = new $this->options['matcher_dumper_class'](
	...
	public function getGenerator() {
		...
		$cache = new ConfigCache(
				...
				$this->options['debug']);
		if (!$cache->isFresh($class)) {
			$dumper = new $this->options['generator_dumper_class'](
					$this->getRouteCollection());
