...
abstract class AnnotationClassLoader implements LoaderInterface {
	...
	public function load($class, $type = null) {
		...
		$globals = array('pattern' => '', 'requirements' => array(),
	...
	protected function addRoute(RouteCollection $collection, $annot, $globals,
		...
		$requirements = array_merge($globals['requirements'],
				$annot->getRequirements());
		$options = array_merge($globals['options'], $annot->getOptions());

		$route = new Route($globals['pattern'] . $annot->getPattern(),
	 ...
	 * @return string
	 */
	protected function getDefaultRouteName(\ReflectionClass $class,
			\ReflectionMethod $method) {
		$name = strtolower(
				str_replace('\\', '_', $class->getName()) . '_'
						. $method->getName());
	...
	abstract protected function configureRoute(Route $route,
