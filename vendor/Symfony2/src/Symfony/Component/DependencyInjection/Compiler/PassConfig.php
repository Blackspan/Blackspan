...
class PassConfig {
	...
	public function __construct() {
		...
		$this->removingPasses = array(new RemovePrivateAliasesPass(),
				new RemoveAbstractDefinitionsPass(),
				new ReplaceAliasByActualDefinitionPass(),
				new RepeatedPass(
						array(new AnalyzeServiceReferencesPass(),
	...
	public function getPasses() {
		return array_merge(array($this->mergePass),
				$this->beforeOptimizationPasses, $this->optimizationPasses,
				$this->beforeRemovingPasses, $this->removingPasses,
	...
	public function addPass(CompilerPassInterface $pass,
			$type = self::TYPE_BEFORE_OPTIMIZATION) {
