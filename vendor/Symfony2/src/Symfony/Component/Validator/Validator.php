...
class Validator implements ValidatorInterface {
	...
	public function validateProperty($object, $property, $groups = null) {
		...
		$walk = function (GraphWalker $walker, $group) use ($metadata,
				$property, $object) {
			return $walker
	 ...
	 * @api
	 */
	public function validatePropertyValue($class, $property, $value,
			$groups = null) {
		...
		$walk = function (GraphWalker $walker, $group) use ($metadata,
				$property, $value) {
			return $walker
					->walkPropertyValue($metadata, $property, $value, $group,
							'');
		};
	...
	protected function validateGraph($root, \Closure $walk, $groups = null) {
		$walker = new GraphWalker($root, $this->metadataFactory,
				$this->validatorFactory, $this->validatorInitializers);
