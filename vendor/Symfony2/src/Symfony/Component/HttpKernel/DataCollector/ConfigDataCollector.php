...
class ConfigDataCollector extends DataCollector {
	...
	public function collect(Request $request, Response $response,
		...
		$this->data = array(
				...
				'eaccel_enabled' => extension_loaded('eaccelerator')
						&& ini_get('eaccelerator.enable'),
				'apc_enabled' => extension_loaded('apc')
						&& ini_get('apc.enabled'),
				'xcache_enabled' => extension_loaded('xcache')
	...
	public function hasAccelerator() {
		return $this->hasApc() || $this->hasEAccelerator()
				|| $this->hasXCache();
	}
